...
execute unless score @s swrg.memcoins matches -2147483648..2147483647 run scoreboard players set @s swrg.memcoins 0
scoreboard players operation @s swrg.memcoins += rnd1 lbc.math
