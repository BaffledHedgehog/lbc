...
tag @s remove left
execute if score #mode lbc.math matches 1 run function lbc:other/event/halloween/soulcorruptwand/cast_2
execute if score #mode lbc.math matches 2 run function lbc:other/event/halloween/soulcorruptwand/cast_upgraded_2_mode_metasola
