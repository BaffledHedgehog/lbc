...
item replace block 10241024 166 10241024 container.0 from entity @s container.13
#                                                                       ############
...
execute if score t lbc.math matches 2 run item replace block 10241024 166 10241024 container.1 from entity @s container.14
...
execute if score t lbc.math matches 4 run item replace block 10241024 166 10241024 container.1 from entity @s weapon.offhand
#                                                                                                                 ############
...
execute if score t lbc.math matches 2 run item replace entity @s container.14 from block 10241024 166 10241024 container.0
...
execute if score t lbc.math matches 4 run item replace entity @s weapon.offhand from block 10241024 166 10241024 container.0
#                                                               ############
item replace entity @s container.13 with pumpkin_seeds
#                      ###########