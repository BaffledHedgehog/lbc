...
item replace block 10241024 166 10241024 container.0 from entity @s container.24
#                                                                       ############
...
execute if score t lbc.math matches 2 run item replace block 10241024 166 10241024 container.1 from entity @s container.23
...
execute if score t lbc.math matches 4 run item replace block 10241024 166 10241024 container.1 from entity @s container.33
#                                                                                                                 ############
...
execute if score t lbc.math matches 2 run item replace entity @s container.23 from block 10241024 166 10241024 container.0
...
execute if score t lbc.math matches 4 run item replace entity @s container.33 from block 10241024 166 10241024 container.0
#                                                               ############
item replace entity @s container.24 with pumpkin_seeds
#                      ###########