...
item replace block 10241024 166 10241024 container.0 from entity @s container.19
#                                                                       ############
...
execute if score t lbc.math matches 4 run item replace block 10241024 166 10241024 container.1 from entity @s container.28
#                                                                                                                 ############
...
execute if score t lbc.math matches 4 run item replace entity @s container.28 from block 10241024 166 10241024 container.0
#                                                               ############
item replace entity @s container.19 with pumpkin_seeds
#                      ###########