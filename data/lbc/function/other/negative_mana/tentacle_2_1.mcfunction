...
execute as @e[type=#mobs,tag=!spectator,tag=!caster,distance=..3,dx=0,dy=0,dz=0,limit=2] run function lbc:other/negative_mana/tentacle_damage with storage lbc.math
