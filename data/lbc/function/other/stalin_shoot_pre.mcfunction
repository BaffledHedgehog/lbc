...
execute if score health lbc.math matches ..495 if score @s simpleTimer matches 0 if predicate lbc:chance50 if entity @e[type=#mobs,distance=..20,tag=!spectator,tag=!stalin] run function lbc:other/stalin_shoot
