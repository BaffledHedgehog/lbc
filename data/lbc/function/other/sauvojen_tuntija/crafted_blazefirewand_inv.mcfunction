...
execute if items entity @s player.crafting.0 *[minecraft:custom_data~{fallingstars:1}] run item modify entity @s player.crafting.0 lbc:count_reduce
execute if items entity @s player.crafting.1 *[minecraft:custom_data~{fallingstars:1}] run item modify entity @s player.crafting.1 lbc:count_reduce
execute if items entity @s player.crafting.2 *[minecraft:custom_data~{fallingstars:1}] run item modify entity @s player.crafting.2 lbc:count_reduce
execute if items entity @s player.crafting.3 *[minecraft:custom_data~{fallingstars:1}] run item modify entity @s player.crafting.3 lbc:count_reduce
