...
execute store result entity @e[type=minecraft:marker,distance=..0.001,tag=raycaster_void_area,limit=1] Rotation[1] float 0.001 run random value -90000..90000
