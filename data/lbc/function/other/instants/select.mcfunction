...
execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{electroblocker:1b}}}]}] unless entity @e[type=marker,tag=stopper,limit=1,distance=..20] run function lbc:workingitems/awaken_tuntija_wands/electroblock/tick