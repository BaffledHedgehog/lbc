...
execute if score #random13 lbc.math matches 3 run attribute @s minecraft:generic.armor base set 10000000
execute if score #random13 lbc.math matches 4 run attribute @s minecraft:generic.armor_toughness base set 10000000
execute if score #random13 lbc.math matches 5 run attribute @s minecraft:generic.attack_damage base set 100000000
execute if score #random13 lbc.math matches 6 run attribute @s minecraft:generic.attack_speed base set 10000000
execute if score #random13 lbc.math matches 7 run attribute @s minecraft:generic.knockback_resistance base set 10000000
execute if score #random13 lbc.math matches 8 run attribute @s minecraft:generic.max_health base set 214708364
