...
execute if score #random14 lbc.math matches 11 run give @s minecraft:carrot_on_a_stick[minecraft:enchantments={levels:{"minecraft:infinity":1}},minecraft:custom_name='{"color":"yellow","italic":false,"translate":"infinite_lucky_block"}',minecraft:lore=['{"translate":"infinite_lucky_block.lore","color":"yellow","italic":false}'],minecraft:custom_data={magicwand:1,luckyblockwand:1,craftusable:1},minecraft:custom_model_data={floats:[605.0f]}] 1
