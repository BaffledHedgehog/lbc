...
execute if score #random14 lbc.math matches 3 run attribute @s generic.burning_time base set -1000000
...
execute if score #random14 lbc.math matches 6 run attribute @s generic.explosion_knockback_resistance base set 10000000
...
execute if score #random14 lbc.math matches 12 run attribute @s generic.water_movement_efficiency base set 10000000
execute if score #random14 lbc.math matches 12 run attribute @s generic.step_height base set 10000000
execute if score #random14 lbc.math matches 12 run attribute @s minecraft:player.sneaking_speed base set 10000000
execute if score #random14 lbc.math matches 12 run attribute @s generic.safe_fall_distance base set 10000000
execute if score #random14 lbc.math matches 12 run attribute @s generic.oxygen_bonus base set 10000000

execute if score #random14 lbc.math matches 13 run attribute @s generic.scale modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.attack_damage modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.attack_knockback modifier add infinity_scale 16 add_value
execute if score #random14 lbc.math matches 13 run attribute @s generic.explosion_knockback_resistance modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.fall_damage_multiplier modifier add infinity_scale -0.9375 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.jump_strength modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.knockback_resistance modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.max_health modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.movement_efficiency modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.movement_speed modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.safe_fall_distance modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.step_height modifier add infinity_scale 16 add_multiplied_total
execute if score #random14 lbc.math matches 13 run attribute @s generic.water_movement_efficiency modifier add infinity_scale 16 add_multiplied_total
...
execute if score #random14 lbc.math matches 13 run attribute @s generic.gravity modifier add infinity_scale 16 add_multiplied_total
