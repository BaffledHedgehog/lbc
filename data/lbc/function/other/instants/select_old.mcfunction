execute at @s[nbt={Inventory:[{components:{"infinity_rand":true}}]}] run function lbc:other/instants/random_infinity
execute at @s[nbt={Inventory:[{components:{penis_bomb:1b}}]}] run function lbc:other/penises/player_select
execute at @s[nbt={Inventory:[{components:{"malevich": true}}]}] run function lbc:other/malevich_fill
