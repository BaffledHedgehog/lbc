execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{infinity_rand:1}}}]}] run function lbc:other/instants/random_infinity
execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{penis_bomb:1}}}]}] run function lbc:other/penises/player_select
execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{malevich:1}}}]}] run function lbc:other/malevich_fill
execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{nexus_wire_black:1}}}]}] run function lbc:other/nexus/wires_other_worlds/black
