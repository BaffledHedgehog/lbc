...
$data modify entity @s Item.tag.spell$(grim) set from entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.tag.spellid
