...
$data modify entity @s Item.components.minecraft:custom_data.spell$(grim) set from entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell":1}}}},limit=1,distance=..1,sort=nearest] Item.components.minecraft:custom_data.spellid
