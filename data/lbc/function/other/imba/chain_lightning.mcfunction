...
execute facing entity @e[type=#minecraft:mobs,distance=..100,tag=!nodmg,tag=!nodmg1,tag=!spectator,limit=1] feet positioned ^ ^ ^ run function lbc:other/imba/chain_lightning_loop
