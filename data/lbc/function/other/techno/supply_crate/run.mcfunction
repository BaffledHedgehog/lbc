...
execute if score @s supplyFall matches 147 run particle cloud ~ ~90 ~ 0.5 20 0.5 0 200 force
execute if score @s supplyFall matches 148 run particle cloud ~ ~60 ~ 0.5 20 0.5 0 200 force
execute if score @s supplyFall matches 149 run particle cloud ~ ~30 ~ 0.5 20 0.5 0 200 force
