...
playsound minecraft:entity.zombie_villager.cure master @a ~ ~ ~ .5 2
execute at @s run tp @s ~ ~ ~ ~ ~-2
clear @s[scores={coldownMagnum=..0}] minecraft:repeating_command_block[minecraft:custom_data~{acid_round:1}] 1
