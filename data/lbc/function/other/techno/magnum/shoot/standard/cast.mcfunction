function lbc:other/techno/magnum/shoot/standard/loop
...
clear @s[scores={coldownMagnum=..0}] minecraft:repeating_command_block[minecraft:custom_data~{standard_round:1}] 1
