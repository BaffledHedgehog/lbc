...
data modify block 10241024 100 10241024 Items[{Slot:0b}].components."minecraft:attribute_modifiers".modifiers[{id:"techkatanadamageboost"}].amount set value 0.05d
