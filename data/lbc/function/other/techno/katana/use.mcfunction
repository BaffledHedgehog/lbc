...
execute store result score tmp lbc.math run data get entity @s SelectedItem.components."minecraft:attribute_modifiers".[{type:"minecraft:movement_speed"}].amount 100
scoreboard players add tmp lbc.math 2

item replace block 10241024 100 10241024 container.0 from entity @s weapon.mainhand
execute store result block 10241024 100 10241024 Items[{Slot:0b}].components."minecraft:attribute_modifiers".[{type:"minecraft:movement_speed"}].amount double 0.01 run scoreboard players get tmp lbc.math
