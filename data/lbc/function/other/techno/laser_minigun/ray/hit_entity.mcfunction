execute at @e[dx=0,dy=0,dz=0,distance=..2,limit=3] unless score @e[distance=..0.0001,limit=1] lbcID2 = *check_id lbcID2 run damage @e[distance=..0.0001,limit=1] 4 generic by @s
