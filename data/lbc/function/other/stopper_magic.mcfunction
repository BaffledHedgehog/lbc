execute unless entity @s[tag=not_block] run fill ~15 ~15 ~15 ~-15 ~-15 ~-15 minecraft:air replace #minecraft:magic strict
...
execute as @e[distance=..20,tag=magic] at @s run function lbc:other/stopper_magic_destroy
