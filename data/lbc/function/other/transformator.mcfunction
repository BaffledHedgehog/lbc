...
execute if predicate lbc:chance5 run effect give @s minecraft:instant_health 1 0
execute if predicate lbc:chance5 run effect give @s minecraft:instant_health 1 1
