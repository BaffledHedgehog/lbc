...
execute if items entity @s player.crafting.0 shield[!minecraft:custom_data~{energy_shield:1}] run item modify entity @s player.crafting.0 lbc:count_reduce
execute if items entity @s player.crafting.1 shield[!minecraft:custom_data~{energy_shield:1}] run item modify entity @s player.crafting.1 lbc:count_reduce
execute if items entity @s player.crafting.2 shield[!minecraft:custom_data~{energy_shield:1}] run item modify entity @s player.crafting.2 lbc:count_reduce
execute if items entity @s player.crafting.3 shield[!minecraft:custom_data~{energy_shield:1}] run item modify entity @s player.crafting.3 lbc:count_reduce
