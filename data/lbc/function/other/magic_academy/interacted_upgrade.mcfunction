...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"lightning_bolts": true}}}}] run function lbc:other/magic_academy/upgrade/lightning_bolts
