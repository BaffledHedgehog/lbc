...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{fartus_nadristailo:1}}}}] run function lbc:other/magic_academy/upgrade/fartus_nadristailo