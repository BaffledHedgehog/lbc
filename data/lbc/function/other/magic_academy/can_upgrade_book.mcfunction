...
data modify block 10241024 100 10241024 Items.[{Slot:0b}].tag.upgrade_available set value 1b
data modify block 10241024 100 10241024 Items.[{Slot:0b}].tag.upgradable set value 0b
