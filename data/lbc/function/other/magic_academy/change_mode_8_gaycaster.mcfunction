...
execute if score #mode lbc.math matches 9.. run scoreboard players set #mode lbc.math 1
...
execute store result block 10241024 100 10241024 Items[{Slot:0b}].components."minecraft:custom_data".color int 1 run scoreboard players get #mode lbc.math
