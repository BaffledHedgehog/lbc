...
execute if entity @s[nbt={SelectedItem:{components:{exoperso:1b}}}] run function lbc:other/magic_academy/can_upgrade/exoperso
...
execute if entity @s[nbt={SelectedItem:{components:{wall:1b}}}] run function lbc:other/magic_academy/can_upgrade/wall
execute if entity @s[nbt={SelectedItem:{components:{advancedteleport:1b}}}] run function lbc:other/magic_academy/can_upgrade/advancedteleport
execute if entity @s[nbt={SelectedItem:{components:{fallingstars:1b}}}] run function lbc:other/magic_academy/can_upgrade/fallingstars
execute if entity @s[nbt={SelectedItem:{components:{truefallingstars:1b}}}] run function lbc:other/magic_academy/can_upgrade/truefallingstars
execute if entity @s[nbt={SelectedItem:{components:{prisma:1b}}}] run function lbc:other/magic_academy/can_upgrade/prisma
...
execute if entity @s[nbt={SelectedItem:{components:{snow_wand:1b}}}] run function lbc:other/magic_academy/can_upgrade/snow_wand
