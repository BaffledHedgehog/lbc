...
execute as @e[type=minecraft:marker,distance=..2,tag=raycastelectro,tag=!actived,limit=7] at @s run tp @s ~ ~ ~ facing entity @e[type=#minecraft:mobs,distance=..30,tag=!transformator,tag=!spectator,sort=nearest,limit=1,tag=!strict_map_object] eyes
