...
execute if score *temp lbc.math matches ..11 run function lbc:other/wisp_book/create_wisp/shadow/spawn
execute if score *temp lbc.math matches 12.. run function lbc:other/wisp_book/create_wisp/shadow/drop_as_item
