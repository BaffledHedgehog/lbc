summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:repeating_command_block",components:{"minecraft:item_model":"lbc:spirit_shadow"},count:1},teleport_duration:2,Tags:["wisp","wisp_shadow","new","rc_5t"]}
