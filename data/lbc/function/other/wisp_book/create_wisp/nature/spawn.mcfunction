summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:repeating_command_block",components:{"minecraft:custom_model_data":{floats:[683.0f]}},count:1},teleport_duration:2,Tags:["wisp","wisp_nature","new","rc_5t","rc_1sec"]}
...
particle minecraft:happy_villager ~ ~ ~ 0 0 0 0.1 20
