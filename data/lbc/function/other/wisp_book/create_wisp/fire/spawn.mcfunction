summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:repeating_command_block",components:{"minecraft:item_model":{floats:[681.0f]}},count:1},teleport_duration:2,Tags:["wisp","wisp_fire","new","rc_5t"]}
