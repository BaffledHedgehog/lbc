...
execute as @e[type=minecraft:item_display,tag=wisp_water] if score @s lbcID2 = @a[tag=check_id,limit=1] lbcID2 run function lbc:other/wisp_book/delete_wisp/kill
