...
execute as @e[dx=0,dy=0,dz=0,distance=..2,type=#mobs,tag=!spectator,tag=!damager] as @a[tag=damager,limit=1,distance=..2] run function lbc:other/wisp_book/passive_effects/air/zap/hit_entity
