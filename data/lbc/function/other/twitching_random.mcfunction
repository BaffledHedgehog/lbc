execute store result score #random5 lbc.math run random value 1..6
...
execute if score #random5 lbc.math matches 3 if items entity @s[nbt={SelectedItem:{id:"minecraft:bow"}}] weapon.* #arrows run function lbc:other/twitching_bow
...
execute if score #random5 lbc.math matches 6 run function lbc:other/twitching_pearl_sel