...
execute if score #random5 lbc.math matches 4 if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow",components:{Charged:1b}}}] run function lbc:other/twitching_bow
