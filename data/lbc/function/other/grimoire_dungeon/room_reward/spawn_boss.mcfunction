...
summon warden ~ ~ ~ {Tags:["grimoire_boss_hitbox","dungeon_mob"],HasVisualFire:0b,Silent:1b,Invulnerable:0b,DeathLootTable:"lbc:grimoire_boss",PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b,Health:1000f,CustomName:'{"translate":"grimoire_boss","color":"dark_red","italic":false}',active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b,show_icon:0b,ambient:0b}],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.armor",Base:1},{Name:"generic.armor_toughness",Base:1}]}
