...
execute facing entity @e[type=#minecraft:mobs,distance=..30,tag=!dungeon_mob,tag=!spectator,sort=nearest,limit=1,tag=!strict_map_object] eyes run tp @e[type=minecraft:item_display,distance=..0.01,tag=thromn_sword,tag=!actived,limit=1] ~ ~ ~ ~ ~
