...
execute as @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..8,tag=!spectator,tag=!dungeon_mob,limit=2,tag=!nodamage] run damage @s 10 magic by @e[type=minecraft:item_display,distance=..100,tag=grimoire_boss_visual,limit=1]
