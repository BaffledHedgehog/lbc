execute positioned ~ ~-6 ~ if entity @e[type=minecraft:warden,distance=..1,tag=grimoire_boss_hitbox,limit=1,team=!] run function lbc:other/grimoire_dungeon/mobs/grimoire_boss/tick1
