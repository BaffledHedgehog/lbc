scoreboard players add @s[nbt={Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"mage": true}}}]}] manaregen_visual 4
scoreboard players add @s[nbt={Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"mage": true}}}]}] manaregen_visual 6
scoreboard players add @s[nbt={Inventory:[{Slot:102b,components:{"minecraft:custom_data":{"mage": true}}}]}] manaregen_visual 7
scoreboard players add @s[nbt={Inventory:[{Slot:103b,components:{"minecraft:custom_data":{"mage": true}}}]}] manaregen_visual 4
