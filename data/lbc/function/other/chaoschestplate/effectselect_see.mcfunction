...
execute if score #random13 lbc.math matches 1 run effect give @s blindness 15 0
execute if score #random13 lbc.math matches 2 run effect give @s darkness 15 0
execute if score #random13 lbc.math matches 3 run effect give @s glowing 60 0
execute if score #random13 lbc.math matches 4 run effect give @s hunger 60 2
execute if score #random13 lbc.math matches 5 run effect give @s instant_damage
...
execute if score #random13 lbc.math matches 13 run effect give @s wither 15