summon item ~ ~ ~ {Health:1000,Motion:[0.0,0.5,0.0],Item:{id:"minecraft:crossbow",count:1,components:{display:{Name:'{"translate":"blaze_crossbow","color":"yellow","bold":true,"italic":false}',Lore:['{"translate":"blaze_crossbow.lore","color": "gold","italic":false}']},ChargedProjectiles:[{id:"minecraft:arrow",count:1},{},{}],"transformable": true,"bow": true,Charged:1b,Enchantments:[{id:"minecraft:quick_charge",lvl:5s}],fastfired:1b,"craftusable": true}}}
