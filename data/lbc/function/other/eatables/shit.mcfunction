...
execute if score #lbcskill swrg.math matches 1 if score @s lbc.skill matches 9 run effect give @s regeneration 10 2
execute if score #lbcskill swrg.math matches 1 if score @s lbc.skill matches 9 run effect give @s instant_health 1 0
