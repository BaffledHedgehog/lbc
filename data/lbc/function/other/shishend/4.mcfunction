...
execute at @e[type=marker,tag=pre.sauv_electro] run summon item_display ~ ~ ~ {interpolation_duration:1,teleport_duration:1,item_display:"fixed",transformation:[0f,0f,2.5000f,0f,1.7678f,-1.7678f,0f,0f,1.7678f,1.7678f,0f,0f,0f,0f,0f,1f],item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":634}},Tags:["sauvojen_electro","area_1s","rc_1sec","savoujen_cloud","magic"]}
