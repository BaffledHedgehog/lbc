execute align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:item_display ~ ~ ~ {Tags:["supply_drop","new","rc_1sec"],Rotation:[0.0f,0.0f],item:{id:"minecraft:stick",components:{"minecraft:item_model":"lbc:supply_beacon"},count:1}}
