...
execute at @e[tag=magicalsheep,distance=..25] run particle minecraft:dust_color_transition{from_color:[0.1, 0.0, 0.1], scale:1, to_color:[10.0, 10.0, 10.0]} ~ ~ ~ 0 0 0 0.01 20 force
