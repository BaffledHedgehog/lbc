effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{mystical:2,type:1}}}]}] regeneration 2 2 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{mystical:2,type:1}}}]}] saturation 2 4 true
