...
summon minecraft:item ~ ~ ~ {Health:10000,Motion:[0.0d,0.2d,0.0d],Item:{id:"minecraft:bow",components:{"minecraft:enchantments":{levels:{"minecraft:infinity":1}},"minecraft:custom_name":'{"bold":true,"color":"green","italic":false,"translate":"shish_bow"}',"minecraft:lore":['[{"translate": "type","italic": false,"color": "aqua"},{"translate": "bow.lbc","italic": false,"color": "aqua"}]','{"translate": "shish_bow.lore","color": "gold","italic": false}'],"minecraft:item_model":{floats:[541.0f]},"minecraft:custom_data":{craftusable:1,transformable:1,bow:1,shish_gun:1}},count:1}}
