particle minecraft:block{block_state:{Name:"minecraft:dirt"}} ~ ~0.7 ~ 0.1 0.1 0.1 0 5 normal
particle minecraft:block{block_state:{Name:"minecraft:brown_wool"}} ~ ~0.7 ~ 0.1 0.1 0.1 0 5 normal
playsound minecraft:lbcsounds.rocket_power master @a[distance=..50] ~ ~ ~ 0.3 1 0.3
