...
execute store result score mana1 lbc.math run data get entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.tag.mana 1
...
execute store result entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.Count byte 0.9999 run data get entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.Count 1
kill @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest,nbt={Item:{Count:0b}}]
execute if entity @e[distance=0.001..1,type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,nbt=!{Item:{Count:0b}}] run function lbc:other/craft_uniwand_with_grimoire
