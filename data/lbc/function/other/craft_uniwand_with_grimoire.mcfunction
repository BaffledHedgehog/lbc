...
execute store result entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.count int 0.9999 run data get entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{"libspell": true}}}},limit=1,distance=..1,sort=nearest] Item.count 1
