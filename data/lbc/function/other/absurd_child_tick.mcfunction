...
execute if score temp_lb_id lbc.math matches 0 run data modify entity @s[nbt={HandItems:[{id:"minecraft:red_mushroom_block",components:{"minecraft:custom_model_data":{floats:[520.0f]}}},{}]}] HandItems set value [{id:"minecraft:brown_mushroom_block",components:{"minecraft:custom_name":'{"color":"light_purple","italic":false,"text":"Lucky Block Neko"}',"minecraft:lore":['{"text":"By BaffledHedgehog","color":"gray","italic":false}'],"minecraft:block_state":{up:"false",down:"false",north:"false",south:"false",east:"false",west:"false"},"minecraft:custom_model_data":{floats:[520.0f]}},count:1},{}]
