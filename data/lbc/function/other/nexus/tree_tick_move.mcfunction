...
execute if entity @e[tag=wire_converter_frame,distance=0.01..5] run kill @s
...
execute if predicate lbc:chance20 at @s run summon marker ~ ~ ~ {Tags:["nexus_tree","nexus_rc"]}