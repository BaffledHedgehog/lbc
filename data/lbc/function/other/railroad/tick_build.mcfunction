...
execute if score tmp_build_if lbc.math matches 0 unless score temp_y lbc.math matches 318.. unless block ^ ^ ^1 #minecraft:airs if entity @s[tag=prev_down] run function lbc:other/railroad/build_straight
execute if score tmp_build_if lbc.math matches 0 if block ^ ^-1 ^1 #minecraft:liquid run function lbc:other/railroad/build_straight
