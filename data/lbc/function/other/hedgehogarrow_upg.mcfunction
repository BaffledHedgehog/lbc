...
execute at @s if entity @e[type=#minecraft:mobs,distance=0.001..17,tag=nodmg,tag=!spectator,limit=1] anchored eyes positioned ^ ^ ^ facing entity @e[type=#minecraft:mobs,distance=0.001..17,tag=!spectator,tag=!nodmg,tag=!nodmg1,sort=nearest,limit=1] eyes run function lbc:other/baffledwall/tick_rc_pl
tag @e remove nodmg
tag @e remove nodmg1