...
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_beef"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_chicken"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_cod"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_mutton"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_porkchop"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_rabbit"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
execute anchored eyes positioned ^ ^ ^0.3 run particle item{item:"cooked_salmon"} ~ ~ ~ 0.1 0.1 0.1 0 2 normal
