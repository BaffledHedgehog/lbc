execute store result score temp_motion_0 lbc.math run random value -10..10
execute store result score temp_motion_1 lbc.math run random value -10..10
execute store result score temp_motion_2 lbc.math run random value -10..10
