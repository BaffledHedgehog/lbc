...
particle minecraft:flame ~ ~.5 ~ 0.2 0.5 0.2 0.5 5 force
execute if predicate lbc:chance20 run playsound minecraft:block.lava.extinguish master @a[distance=..20] ~ ~ ~ 0.5 1 0.1
