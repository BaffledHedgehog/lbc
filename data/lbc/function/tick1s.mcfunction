...
execute as @e[type=item,nbt={Item:{components: {"minecraft:custom_data":{"craftusable": true}}}}] at @s if entity @e[distance=0.001..1,type=item,nbt={Item:{components: {"minecraft:custom_data":{"craftusable": true}}}},limit=1] unless dimension minecraft:nexus run function lbc:other/craft_ground
