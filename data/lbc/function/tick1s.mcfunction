...
execute as @e[type=item,nbt={Item:{components:{"craftusable": true}}}] at @s if entity @e[distance=0.001..1,type=item,nbt={Item:{components:{"craftusable": true}}},limit=1] unless dimension minecraft:nexus run function lbc:other/craft_ground
execute as @e[type=item,nbt={Item:{components:{uniwand:1b}}}] at @s if entity @e[distance=0.001..1,type=item,nbt={Item:{components:{"libspell": true}}},limit=1] unless dimension minecraft:nexus run function lbc:other/craft_uniwand_with_grimoire
