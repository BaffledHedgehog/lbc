...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{techrunner_katana:1}}}}] run function lbc:other/techno/katana/speed_based_change
#tellraw @a [{"text":"speed:  ","extra":[{"score":{"objective": "speed","name":"@s"}}]},{"text":"|  atk bonus:  ","extra":[{"score":{"objective": "lbc.math","name":"tmp"}}]}]
execute unless entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{techrunner_katana:1}}}}] run attribute @s minecraft:attack_damage modifier remove minecraft:a286fd96-0981-4d73-a4b4-cd298373175a
