...
execute unless entity @s[nbt={SelectedItem:{components: {"minecraft:custom_data":{"techrunner_katana": true}}}}] run attribute @s generic.attack_damage modifier remove a286fd96-0981-4d73-a4b4-cd298373175a
