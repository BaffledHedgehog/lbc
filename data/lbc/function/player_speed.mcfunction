...
execute unless entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{techrunner_katana:1}}}}] run attribute @s minecraft:attack_damage modifier remove a286fd96-0981-4d73-a4b4-cd298373175a
