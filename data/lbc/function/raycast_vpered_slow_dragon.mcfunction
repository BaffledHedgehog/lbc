...
execute positioned 0.0 0.0 0.0 positioned ^ ^ ^1 run summon minecraft:marker ~.0 ~.0 ~.0 {Tags:["reycaster"]}
...
execute store result entity @s Motion[1] double 0.0002 run data get entity @e[type=minecraft:marker,tag=reycaster,limit=1] Pos[1] 10000
