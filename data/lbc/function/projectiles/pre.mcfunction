...
execute if entity @s[tag=volos_arrow] if predicate lbc:chance50 if entity @e[type=#minecraft:mobs,distance=..100,tag=!spectator,limit=1] run function lbc:swrg_kit_integration/game/trinkets/volos_arrow_tick
