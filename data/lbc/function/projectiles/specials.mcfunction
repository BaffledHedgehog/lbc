# Knifes
execute if data entity @s Item.tag{bigexplode:1b} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],Color:16777215,ShotFromCrossbow:1b,PierceLevel:100b,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:107b,duration:2}]}
execute if data entity @s Item.tag{"smoke": true} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],Color:16777215,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:106b,duration:20}]}
execute if data entity @s Item.tag{smoke_old:1b} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],Color:16777215,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:114b,duration:20}]}
execute if data entity @s Item.tag{"luckygrenade": true} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],Color:16772608,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:108b,duration:2}]}
execute if data entity @s Item.tag{"confuse":true} run summon arrow ^ ^ ^ {pickup:2b,damage:3.0d,Tags:["edited","killedarrow"],Color:11733922,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:105b,duration:2}]}
...
execute if data entity @s Item.tag{"boom":true} run summon arrow ^ ^ ^ {custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:104b,duration:2}],Color:16756516,Tags:["edited"]}
...
execute if data entity @s Item.tag{"spike_confuse": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.0d,Tags:["edited","killedarrow"],Color:16746227,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:115b,duration:2}]}
execute if data entity @s Item.tag{"spike_blind": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.5d,Tags:["edited","killedarrow"],Color:16771895,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:116b,duration:2}]}
execute if data entity @s Item.tag{"spike_poison": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.5d,Tags:["edited","killedarrow"],Color:1119083,custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:117b,duration:2}]}
...
execute if data entity @s Item.tag{"spike_boom": true} run summon arrow ^ ^ ^ {custom_potion_effects:[{id:"minecraft:raid_omen",amplifier:118b,duration:2}],Color:9079434,Tags:["edited"],damage:0.01d}
...
execute if data entity @s Item.tag{"throwable_metal_pipe": true} run summon item ^ ^ ^ {PickupDelay:10s,Item:{id:"minecraft:spyglass",count:1,components:{display:{Name:'{"translate":"metal_pipe","italic": false}',Lore:['{ "translate": "type", "italic": false, "color": "aqua"}','{ "translate": "sword", "italic": false, "color": "aqua"}','{ "translate": "craft_with_divider", "italic": false, "color": "yellow"}']},"minecraft:custom_model_data":594,"metal_pipe": true,"craftusable": true,"transformable": true,"sword": true,AttributeModifiers:[{AttributeName:"minecraft:generic.attack_damage",id:"generic.attack_damage",Amount:10,Operation:0,UUID:[I;291294886,-243577490,-1461500507,-860357035],Slot:"mainhand"},{AttributeName:"minecraft:generic.attack_speed",id:"generic.attack_speed",Amount:-3.1,Operation:0,UUID:[I;1250175964,217664547,-1671179780,-1322344299],Slot:"mainhand"}]}},Tags:["edited"]}
