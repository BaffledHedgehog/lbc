# Knifes
execute if data entity @s Item.components.minecraft:custom_data{bigexplode:1b} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],PierceLevel:100b,item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:107b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"smoke": true} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:106b,duration:20}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{smoke_old:1b} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:114b,duration:20}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"luckygrenade": true} run summon arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16772608,custom_effects:[{id:"minecraft:raid_omen",amplifier:108b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"confuse":true} run summon arrow ^ ^ ^ {pickup:2b,damage:3.0d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:11733922,custom_effects:[{id:"minecraft:raid_omen",amplifier:105b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"blind":true} run summon arrow ^ ^ ^ {pickup:2b,damage:2.5d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:0,custom_effects:[{id:"minecraft:blindness",amplifier:0b,duration:120}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"poison":true} run summon arrow ^ ^ ^ {pickup:2b,damage:2.5d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:392982,custom_effects:[{id:"minecraft:poison",amplifier:2b,duration:100}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"wither":true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.8d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:7368816,custom_effects:[{id:"minecraft:wither",amplifier:2b,duration:100}]}}}}
...
execute if data entity @s Item.components.minecraft:custom_data{"boom":true} run summon arrow ^ ^ ^ {Tags:["edited"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16756516,custom_effects:[{id:"minecraft:raid_omen",amplifier:104b,duration:2}]}}}}
...
execute if data entity @s Item.components.minecraft:custom_data{"spike_confuse": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.0d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16746227,custom_effects:[{id:"minecraft:raid_omen",amplifier:115b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"spike_blind": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.5d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:16771895,custom_effects:[{id:"minecraft:raid_omen",amplifier:116b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"spike_poison": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.5d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:1119083,custom_effects:[{id:"minecraft:raid_omen",amplifier:117b,duration:2}]}}}}
execute if data entity @s Item.components.minecraft:custom_data{"spike_wither": true} run summon arrow ^ ^ ^ {pickup:2b,damage:1.0d,Tags:["edited","killedarrow"],item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:0,custom_effects:[{id:"minecraft:water_breathing",amplifier:1b,duration:600}]}}}}
...
execute if data entity @s Item.components.minecraft:custom_data{"spike_boom": true} run summon arrow ^ ^ ^ {Tags:["edited"],damage:0.01d,item:{id:"tipped_arrow",count:1,components:{potion_contents:{custom_color:9079434,custom_effects:[{id:"minecraft:raid_omen",amplifier:118b,duration:2}]}}}}
