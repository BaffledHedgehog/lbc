# Knifes
execute if data entity @s Item.components.minecraft:custom_data{bigexplode:1} run summon minecraft:arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],PierceLevel:100b,item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:107b,duration:2}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"smoke":1} run summon minecraft:arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:106b,duration:20}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{smoke_old:1} run summon minecraft:arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:114b,duration:20}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"luckygrenade":1} run summon minecraft:arrow ^ ^ ^ {damage:0.01d,Tags:["edited","killedarrow"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16772608,custom_effects:[{id:"minecraft:raid_omen",amplifier:108b,duration:2}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"confuse":1} run summon minecraft:arrow ^ ^ ^ {pickup:2b,damage:3.0d,Tags:["edited","killedarrow"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:11733922,custom_effects:[{id:"minecraft:raid_omen",amplifier:105b,duration:2}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"blind":1} run summon minecraft:arrow ^ ^ ^ {pickup:2b,damage:2.5d,Tags:["edited","killedarrow"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:0,custom_effects:[{id:"minecraft:blindness",amplifier:0b,duration:120}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"poison":1} run summon minecraft:arrow ^ ^ ^ {pickup:2b,damage:2.5d,Tags:["edited","killedarrow"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:392982,custom_effects:[{id:"minecraft:poison",amplifier:2b,duration:100}]},potion_duration_scale:1.0},count:1}}
execute if data entity @s Item.components.minecraft:custom_data{"wither":1} run summon minecraft:arrow ^ ^ ^ {pickup:2b,damage:1.8d,Tags:["edited","killedarrow"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:7368816,custom_effects:[{id:"minecraft:wither",amplifier:2b,duration:100}]},potion_duration_scale:1.0},count:1}}
...
execute if data entity @s Item.components.minecraft:custom_data{"boom":1} run summon minecraft:arrow ^ ^ ^ {Tags:["edited"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16756516,custom_effects:[{id:"minecraft:raid_omen",amplifier:104b,duration:2}]},potion_duration_scale:1.0},count:1}}
...
execute if data entity @s Item.components.minecraft:custom_data{"spike_boom":1} run summon minecraft:arrow ^ ^ ^ {Tags:["edited"],damage:0.01d,item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:9079434,custom_effects:[{id:"minecraft:raid_omen",amplifier:118b,duration:2}]},potion_duration_scale:1.0},count:1}}
...
execute if data entity @s Item.components.minecraft:custom_data{"dynamite":1} run summon minecraft:tnt ^ ^1 ^ {Tags:["edited6","can_deleted","groundbam","dynamite"],fuse:1000s}
execute if data entity @s Item.components.minecraft:custom_data{"smoke_bomb":1} run summon minecraft:arrow ^ ^ ^ {damage:0.01d,Tags:["edited"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16777215,custom_effects:[{id:"minecraft:raid_omen",amplifier:97b,duration:20}]},potion_duration_scale:1.0},count:1}}
