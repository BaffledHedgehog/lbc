...
execute if score tmp lbc.math matches 101 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run summon creeper ~ ~ ~ {Silent:1b,Invulnerable:1b,ExplosionRadius:1b,Fuse:0,ignited:1b}
...
execute if score tmp lbc.math matches 104 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run summon tnt ~ ~ ~ {fuse:2s}
execute if score tmp lbc.math matches 107 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run function lbc:projectiles/arrows/bigexplode
...
execute if score tmp lbc.math matches 109 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run summon lightning_bolt ~ ~ ~
execute if score tmp lbc.math matches 110 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run fill ~3 ~3 ~3 ~-3 ~-3 ~-3 fire replace #airs
execute if score tmp lbc.math matches 110 unless entity @a[distance=..12,nbt={Inventory:[{components:{mystical:1,type:2}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run fill ~1.5 ~1.5 ~1.5 ~-1.5 ~-1.5 ~-1.5 air destroy
