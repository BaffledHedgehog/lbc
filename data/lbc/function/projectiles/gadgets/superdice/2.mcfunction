...
execute store result score tmp lbc.math run attribute @s minecraft:generic.knockback_resistance get 100
...
execute store result score tmp lbc.math run attribute @s minecraft:generic.armor get 1000
scoreboard players operation tmp lbc.math /= 2 lbc.math
...
execute store result score tmp lbc.math run attribute @s minecraft:generic.armor_toughness get 1000
scoreboard players operation tmp lbc.math /= 2 lbc.math
execute store result storage lbcmath tmp double 0.001 run scoreboard players get tmp lbc.math
function lbc:other/attributes/armor_toughness_update with storage minecraft:lbcmath

execute store result score tmp lbc.math run attribute @s minecraft:generic.attack_damage get 10
scoreboard players operation tmp lbc.math /= 2 lbc.math
...
execute store result score tmp lbc.math run attribute @s minecraft:generic.attack_speed get 100
scoreboard players operation tmp lbc.math /= 2 lbc.math
execute store result storage lbcmath tmp double 0.01 run scoreboard players get tmp lbc.math
function lbc:other/attributes/attack_speed_update with storage minecraft:lbcmath

execute store result score tmp lbc.math run attribute @s minecraft:generic.luck get 10
scoreboard players operation tmp lbc.math /= 2 lbc.math
execute store result storage lbcmath tmp double 0.1 run scoreboard players get tmp lbc.math
function lbc:other/attributes/luck_update with storage minecraft:lbcmath

execute store result score tmp lbc.math run attribute @s minecraft:generic.max_health get 1
scoreboard players operation tmp lbc.math /= 2 lbc.math
...
execute store result score tmp lbc.math run attribute @s minecraft:generic.movement_speed get 10000
scoreboard players operation tmp lbc.math /= 2 lbc.math
