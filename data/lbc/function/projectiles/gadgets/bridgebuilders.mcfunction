execute if data entity @s Item.components.minecraft:custom_data{"most":1} run fill ~0.5 ~-2.5 ~0.5 ~-0.5 ~-2.5 ~-0.5 minecraft:lime_wool replace minecraft:air strict
execute if data entity @s Item.components.minecraft:custom_data{tntmost:1} run fill ~0.5 ~-2.5 ~0.5 ~-0.5 ~-2.5 ~-0.5 minecraft:tnt replace minecraft:air strict
