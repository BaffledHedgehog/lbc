...
execute if data entity @s Item.tag{bucket:1b} run function lbc:projectiles/gadgets/bucket
execute if data entity @s Item.tag{wool:1b} run function lbc:projectiles/gadgets/wools/select
execute if data entity @s Item.tag{tikva:1b} run function lbc:projectiles/gadgets/tikva
execute if data entity @s Item.tag{honew:1b} run function lbc:projectiles/gadgets/honew