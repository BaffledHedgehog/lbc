...
execute at @s facing entity @e[type=#minecraft:mobs,tag=!nodmg,tag=!spectator,sort=nearest,limit=1,tag=!strict_map_object] eyes positioned ^ ^ ^ run function lbc:raycast_vpered_very_slow_vect with storage lbc.math
tag @a remove nodmg
