...
execute if score @s blaze matches 1.. unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:other/blazehead
execute if entity @s[tag=have_stand,tag=have_stand_clocks_active] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:other/stand_arrow/tick_10t_stand_clocks
...
function lbc:other/event/halloween/pumpkin_king_sword/tick_10t
