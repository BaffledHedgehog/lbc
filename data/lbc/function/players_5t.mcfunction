...
execute if entity @s[tag=chaosdust_active] run particle dust 10 10 10 1 ~ ~1 ~ 0.3 0.3 0.3 0 3 normal
execute if entity @s[nbt={SelectedItem: {components: {arcanum5t: 1b}}}] unless entity @e[type=marker,tag=stopper_magic,limit=1,distance=..20] run function lbc:items/arcanums/5true/select
execute if entity @s[tag=arcanum5t_use] unless entity @s[nbt={SelectedItem: {components: {arcanum5t: 1b}}}] run function lbc:items/arcanums/end5t
execute if entity @s[nbt={Inventory: [{Slot: -106b, components: {arcanum5t: 1b}}]}] unless entity @e[type=marker,tag=stopper_magic,limit=1,distance=..20] run function lbc:items/arcanums/5true/select2
execute if entity @s[tag=arcanum5t_use2] unless entity @s[nbt={Inventory: [{components: {arcanum5t: 1b}, Slot: -106b}]}] run function lbc:items/arcanums/end25t
