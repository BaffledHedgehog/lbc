...
execute facing entity @e[type=#minecraft:mobs,tag=!spectator,tag=!nohomo,sort=nearest,limit=1,tag=!strict_map_object] eyes run function lbc:raycast_vpered_slower
tag @a remove nohomo