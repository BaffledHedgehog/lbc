...
execute if data entity @s[tag=!spectator] active_effects[{id:"minecraft:raid_omen"}] run function lbc:other/drownpre
execute if score @s[tag=!spectator] effect_rtp_1 matches 1.. run function lbc:effects/rtp_1
execute if score @s[tag=!spectator] effect_rtp_2 matches 1.. run function lbc:effects/rtp_2
execute if score @s[tag=!spectator] effect_rtp_3 matches 1.. run function lbc:effects/rtp_3
