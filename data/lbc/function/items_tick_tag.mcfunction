...
tag @s[nbt={Item: {components: {"malevich": true}}}] add malevich
tag @s[nbt={Glowing: 1b}] add glowing
tag @s[nbt={Item: {components: {penis_bomb: 1b}}}] add penis_bomb
tag @s[type=item,nbt={Item: {components: {"copypaster":true}}}] add copypaster

tag @s[type=item,nbt={Item: {components: {multiply: 2}}}] add multiply_item
tag @s[type=item,nbt={Item: {components: {multiply: 3}}}] add multiply_item
...
tag @s[nbt={Item: {components: {"malevich": true}}}] add working
tag @s[nbt={Glowing: 1b}] add working
tag @s[nbt={Item: {components: {penis_bomb: 1b}}}] add working
tag @s[type=item,nbt={Item: {components: {"copypaster":true}}}] add working
tag @s[type=item,nbt={Item: {components: {multiply: 2}}}] add working
tag @s[type=item,nbt={Item: {components: {multiply: 3}}}] add working
tag @s[type=item,nbt={Item: {components: {multiply: 4}}}] add working