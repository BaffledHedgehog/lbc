summon minecraft:armor_stand ~ ~ ~ {Tags:["mom","rc_1sec"],CustomNameVisible:1b,ShowArms:1b,Invulnerable:1b,NoBasePlate:1b,DisabledSlots:4144959,HandItems:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_model_data":{floats:[620.0f]}},count:1},{}],Pose:{LeftLeg:[180.0f,0.0f,0.0f],RightLeg:[180.0f,0.0f,0.0f],RightArm:[0.0f,0.0f,0.0f]}}
