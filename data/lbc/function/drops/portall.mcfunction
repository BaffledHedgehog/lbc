...
execute at @e[tag=randomportal] run setblock ~ ~4 ~ minecraft:bedrock
execute at @e[tag=randomportal] run setblock ~ ~3 ~ minecraft:end_gateway{ExactTeleport:1b,exit_portal:[I;0,100,0]}

setblock ~ ~-1 ~ minecraft:bedrock
setblock ~ ~4 ~ minecraft:bedrock
setblock ~ ~3 ~ minecraft:end_gateway{ExactTeleport:1b,exit_portal:[I;0,100,0]}
