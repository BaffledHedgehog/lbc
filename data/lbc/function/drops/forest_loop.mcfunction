...
execute if score #random12 lbc.math matches 7 run summon zombie ~ ~ ~ {CustomNameVisible:1b,DeathLootTable:"lbc:reactive_shish",PersistenceRequired:1b,Health:30f,IsBaby:1b,CustomName:'{"translate":"reactive_shish","color":"green","italic":false}',active_effects:[{id:"minecraft:jump_boost",amplifier:6b,duration:2000000,show_particles:0b},{id:"minecraft:fire_resistance",amplifier:0b,duration:2000000,show_particles:0b}],Attributes:[{Name:"generic.max_health",Base:30},{Name:"generic.attack_knockback",Base:1}],ArmorItems:[{},{},{},{id:"minecraft:spruce_sapling",Count:1b}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F]}
...
execute unless score #random12 lbc.math matches 7 run summon zombie ~1 ~ ~1 {IsBaby:1b}
