execute unless block ~ ~ ~ #airs run summon tnt
...
execute if score tmp lbc.math matches 642 run data modify entity @s item.components.minecraft:custom_model_data set value 643
execute if score tmp lbc.math matches 643 run data modify entity @s item.components.minecraft:custom_model_data set value 644
execute if score tmp lbc.math matches 644 run data modify entity @s item.components.minecraft:custom_model_data set value 645
execute if score tmp lbc.math matches 645 run data modify entity @s item.components.minecraft:custom_model_data set value 642
