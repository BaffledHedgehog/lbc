...
execute store result score tmp lbc.math run data get entity @s item.components."minecraft:item_model" 1
execute if score tmp lbc.math matches 642 run data modify entity @s item.components."minecraft:item_model" set value {floats:[643.0f]}
execute if score tmp lbc.math matches 643 run data modify entity @s item.components."minecraft:item_model" set value {floats:[644.0f]}
execute if score tmp lbc.math matches 644 run data modify entity @s item.components."minecraft:item_model" set value {floats:[645.0f]}
execute if score tmp lbc.math matches 645 run data modify entity @s item.components."minecraft:item_model" set value {floats:[642.0f]}
