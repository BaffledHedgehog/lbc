summon turtle ~ ~ ~ {attributes:[{id:"minecraft:max_health",base:100200},{"id":"minecraft:scale","base":10.0}],active_effects:[{"id":"minecraft:invisibility",show_particles:false,duration:-1}],Tags:["lucky_mob_5s","crocodildo","mecha"],Passengers:[{"id":"item_display",Tags:["slowraycast","rare","crocodildo_hitbox","mecha","mob"],item:{id:"minecraft:stick",count:1,components:{"item_model":"lbc:crocodildo"}},billboard:"fixed",interpolation_duration:1,shadow_radius:0,shadow_strength:0,teleport_duration:1,view_range:1000,start_interpolation:0,transformation:[15f,0f,0f,0f,0f,15f,0f,1f,0f,0f,15f,0f,0f,0f,0f,1f]}],CustomNameVisible:true,CustomName:{"translate":"crocodilo","color":"dark_red","bold":true},PersistenceRequired:true}
