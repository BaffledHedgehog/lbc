...
execute store result storage lbc.math valued double 0.01 run random value -50..100
execute if predicate lbc:chance1 store result storage lbc.math valued double 0.01 run random value -1000000000..1000000000
execute if predicate lbc:chance10 store result storage lbc.math valued double 0.01 run random value -200..1200
execute if predicate lbc:chance10 store result storage lbc.math valued double 0.01 run random value -100..400
