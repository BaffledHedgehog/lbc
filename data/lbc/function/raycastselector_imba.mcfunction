...
execute if entity @s[tag=erecto_sniper_bruh] run return run function lbc:workingitems/awaken_tuntija_wands/erecto/click_upgraded_2_mode_sniper_charge_bruh
execute if entity @s[tag=imba_most] if entity @a[gamemode=!spectator,distance=..200] run return run function lbc:other/imba/most_tick
execute if entity @s[tag=imba_kara] run return run function lbc:items/swords/imba_kara_slab/tick_kara
