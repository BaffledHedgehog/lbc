...
scoreboard players set #tmp1 lbc.math 0
execute store result score #tmp1 lbc.math run data get entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{glass:1}},Slot:100b}]}] Inventory[{Slot:100b}].components."minecraft:attribute_modifiers".modifiers[{type:"minecraft:armor"}].amount 0.17
scoreboard players operation tmp lbc.math += #tmp1 lbc.math
scoreboard players set #tmp1 lbc.math 0
execute store result score #tmp1 lbc.math run data get entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{glass:1}},Slot:101b}]}] Inventory[{Slot:101b}].components."minecraft:attribute_modifiers".modifiers[{type:"minecraft:armor"}].amount 0.17
scoreboard players operation tmp lbc.math += #tmp1 lbc.math
scoreboard players set #tmp1 lbc.math 0
execute store result score #tmp1 lbc.math run data get entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{glass:1}},Slot:102b}]}] Inventory[{Slot:102b}].components."minecraft:attribute_modifiers".modifiers[{type:"minecraft:armor"}].amount 0.17
scoreboard players operation tmp lbc.math += #tmp1 lbc.math
scoreboard players set #tmp1 lbc.math 0
execute store result score #tmp1 lbc.math run data get entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{glass:1}},Slot:103b}]}] Inventory[{Slot:103b}].components."minecraft:attribute_modifiers".modifiers[{type:"minecraft:armor"}].amount 0.17
scoreboard players operation tmp lbc.math += #tmp1 lbc.math
