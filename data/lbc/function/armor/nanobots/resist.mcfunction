effect give @s[scores={nanobots_tier=4..11}] minecraft:resistance 1 0 true
effect give @s[scores={nanobots_tier=12..23}] minecraft:resistance 1 1 true
effect give @s[scores={nanobots_tier=24..39}] minecraft:resistance 1 2 true
effect give @s[scores={nanobots_tier=40..59}] minecraft:resistance 1 3 true
effect give @s[scores={nanobots_tier=60..}] minecraft:resistance 1 4 true
