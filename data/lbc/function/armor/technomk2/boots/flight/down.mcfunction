...
execute if entity @s[nbt={Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"technomk2": true}}}]}] store result storage lbc.math tmp double 0.005 run data get entity @s Rotation[1] 100
