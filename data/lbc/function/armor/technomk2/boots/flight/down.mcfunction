...
execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{technomk2:1}},Slot:101b}]}] store result storage lbc.math tmp double 0.001 run data get entity @s Rotation[1] 100
