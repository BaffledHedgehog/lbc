...
effect give @s[nbt=!{Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"technomk2": true}}}]}] levitation 1 20 true
effect give @s[nbt={Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"technomk2": true}}}]}] levitation 1 60 true
