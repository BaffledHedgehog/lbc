...
attribute @s generic.movement_speed modifier remove c1cda724-0ea2-460a-98b8-9631eafd2515
attribute @s generic.attack_damage modifier remove 585f98b8-a8b8-4e4c-838a-f2e124831040
