...
execute store result score tmp1 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[0] 10000
execute store result score tmp2 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[1] 10000
execute store result score tmp3 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[2] 10000
