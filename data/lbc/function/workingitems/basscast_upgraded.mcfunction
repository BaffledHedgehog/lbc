...
execute if score #mode lbc.math matches 1 run effect give @e[distance=0.01..25,tag=!spectator,predicate=!lbc:same_team] minecraft:weakness 8 0 true
execute if score #mode lbc.math matches 2 run effect give @e[distance=0.01..25,tag=!spectator,predicate=!lbc:same_team] minecraft:slowness 12 3 true
execute if score #mode lbc.math matches 3 run effect give @a[gamemode=!spectator,distance=0.01..25,predicate=!lbc:same_team] minecraft:blindness 8 0 true
execute if score #mode lbc.math matches 4 run effect give @e[distance=0.01..25,tag=!spectator,predicate=!lbc:same_team] minecraft:mining_fatigue 9 0 true
