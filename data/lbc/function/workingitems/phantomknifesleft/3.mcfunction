execute anchored eyes positioned ^ ^ ^0.5 run summon arrow ~ ~ ~ {pickup:0b,damage:1d,PierceLevel:127b,Tags:["killedarrow","phantomarrow1"]}
execute positioned 0.0 0.0 0.0 run summon marker ^ ^-0.01 ^1 {Tags:["reikast"]}
