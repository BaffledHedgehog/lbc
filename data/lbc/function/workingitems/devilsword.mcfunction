...
execute if entity @s[nbt={SelectedItem:{components:{"heal": true}}}] unless entity @s[nbt={active_effects:[{id:"minecraft:strength"}]}] run function lbc:workingitems/devilswordattacks/1
