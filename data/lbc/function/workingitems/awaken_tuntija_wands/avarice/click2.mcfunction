...
execute positioned ^ ^ ^7 run scoreboard players operation @e[type=minecraft:marker,distance=..0.001,tag=dublicating,tag=!actived,limit=1] lbcID2 = @s lbcID2
execute positioned ^ ^ ^7 run scoreboard players operation @e[type=minecraft:marker,distance=..0.001,tag=dublicating,tag=!actived,limit=1] team_number = @s team_number
