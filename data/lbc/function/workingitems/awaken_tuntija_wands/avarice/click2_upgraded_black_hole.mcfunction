...
execute positioned ^ ^ ^8 run scoreboard players operation @e[type=minecraft:marker,distance=..0.001,tag=dublicated_hole,tag=!actived,limit=1] team_number = @s team_number
