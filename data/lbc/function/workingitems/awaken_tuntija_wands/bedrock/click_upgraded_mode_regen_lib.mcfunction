...
execute unless entity @e[type=minecraft:marker,tag=bedrock_room_regen,tag=curr_wall] run function lbc:workingitems/awaken_tuntija_wands/bedrock/create_room_regen_lib
