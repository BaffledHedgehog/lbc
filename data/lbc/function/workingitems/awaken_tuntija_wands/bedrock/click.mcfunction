...
execute if entity @s[predicate=lbc:sneak,nbt={SelectedItem:{components:{upgradable:1b}}}] run function lbc:workingitems/awaken_tuntija_wands/bedrock/click_upgrade