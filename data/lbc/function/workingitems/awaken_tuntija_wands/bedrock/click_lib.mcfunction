...
execute unless entity @e[type=minecraft:marker,tag=bedrock_room,tag=curr_wall] run function lbc:workingitems/awaken_tuntija_wands/bedrock/create_room_lib
