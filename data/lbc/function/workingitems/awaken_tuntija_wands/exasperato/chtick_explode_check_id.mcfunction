...
execute as @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..15,tag=!spectator] if score @s team_number = @e[tag=exasperato,sort=nearest,limit=1] team_number run tag @s add nodamage
