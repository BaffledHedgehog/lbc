...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"upgradable": true}}}}] run tag @e[type=marker,tag=exasperato,limit=1,distance=..0.0001,tag=!actived] add check_upgrade
