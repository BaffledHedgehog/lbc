...
execute if entity @s[nbt={SelectedItem:{components:{upgradable:1b}}}] run tag @e[type=marker,tag=exasperato,limit=1,distance=..0.0001,tag=!actived] add check_upgrade
