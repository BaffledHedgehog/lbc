...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{upgradable:1b}}}}] run tag @e[type=marker,tag=erecto_arc,limit=8,distance=..0.0001,tag=!active] add check_upg
