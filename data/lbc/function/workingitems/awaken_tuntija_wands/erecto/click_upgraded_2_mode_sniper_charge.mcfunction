...
particle minecraft:dust_color_transition{from_color:[0.0,0.8,1.0],scale:0.8f,to_color:[0.9,0.9,1.2]} ~ ~ ~ 0.1 0.1 0.1 0 1 force
...
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..8,tag=!spectator,tag=!transformator,limit=1] run function lbcr:damagewithid_extreme
execute unless block ~ ~ ~ #minecraft:airs run function lbc:workingitems/awaken_tuntija_wands/erecto/central_end_2
