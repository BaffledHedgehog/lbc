...
execute unless block ~ ~ ~ #airs run summon creeper ~ ~ ~ {Fuse:0s,ExplosionRadius:20b,PersistenceRequired:1b,ignited:1b,Invulnerable:1b,Silent:1b,Health:10000f,Attributes:[{Name:"minecraft:generic.max_health",Base:10000d}]}
