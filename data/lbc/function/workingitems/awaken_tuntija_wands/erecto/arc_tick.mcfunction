...
playsound minecraft:entity.firework_rocket.twinkle master @a ~ ~ ~ 0.01 2
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..10,tag=!spectator,limit=1] run function lbcr:damagewithid_dzibdzun
execute unless block ~ ~ ~ #minecraft:airs run function lbc:workingitems/awaken_tuntija_wands/erecto/central_end
