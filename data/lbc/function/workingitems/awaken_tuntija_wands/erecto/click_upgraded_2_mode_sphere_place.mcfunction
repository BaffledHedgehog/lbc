...
execute positioned ^ ^ ^-1 run scoreboard players operation @e[type=minecraft:marker,distance=..0.0001,tag=erecto_sphere,tag=!actived,limit=1] team_number = @s team_number
