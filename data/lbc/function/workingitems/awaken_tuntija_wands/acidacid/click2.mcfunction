...
execute if entity @s[predicate=lbc:on_fire,nbt={SelectedItem:{components:{"minecraft:custom_data":{upgradable:1b}}}}] run function lbc:other/magic_academy/can_upgrade
