...
execute if predicate lbc:sneak unless entity @s[x_rotation=89..90] run function lbc:other/magic_academy/change_mode_4_left
execute if predicate lbc:sneak if entity @s[x_rotation=89..90] run function lbc:other/magic_academy/change_tier_2_left
