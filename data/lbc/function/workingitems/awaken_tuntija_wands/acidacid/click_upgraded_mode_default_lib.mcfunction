summon minecraft:marker ^ ^ ^ {data:{lifetime:500},Tags:["great_acid","rare","slowraycast","magic","on_fire"]}
...
scoreboard players operation @e[type=minecraft:marker,distance=..0.0001,tag=great_acid,tag=!actived,limit=1] team_number = @s team_number
