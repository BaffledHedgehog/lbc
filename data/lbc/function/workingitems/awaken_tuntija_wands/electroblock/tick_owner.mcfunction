...
execute if score @e[type=#minecraft:projectiles,tag=!no_repell,sort=nearest,limit=1] team_number = @s team_number run tag @e[type=#minecraft:projectiles,tag=!no_repell,sort=nearest,limit=1] add no_repell
