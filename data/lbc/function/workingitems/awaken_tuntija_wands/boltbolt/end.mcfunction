...
execute if entity @s[nbt={SelectedItem:{components:{boltbolt_wand:1b,upgradable:1b}}}] if entity @e[type=#mobs,tag=!spectator,distance=..5,tag=!raycaster,scores={shock=60..}] at @s run function lbc:other/magic_academy/can_upgrade
