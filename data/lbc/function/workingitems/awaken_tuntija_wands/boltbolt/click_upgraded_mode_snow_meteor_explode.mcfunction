...
fill ~7 ~10 ~10 ~-7 ~-10 ~-10 minecraft:snow_block replace #minecraft:tannerkivi
fill ~10 ~10 ~7 ~-10 ~-10 ~-7 minecraft:snow_block replace #minecraft:tannerkivi
fill ~10 ~7 ~10 ~-10 ~-7 ~-10 minecraft:snow_block replace #minecraft:tannerkivi
