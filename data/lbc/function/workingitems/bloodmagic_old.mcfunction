...
effect give @a[distance=0.1..10] minecraft:instant_damage 1 1
effect give @a[distance=0.1..10] minecraft:hunger 60 255
effect give @a[distance=0.1..10] minecraft:wither 25 1
