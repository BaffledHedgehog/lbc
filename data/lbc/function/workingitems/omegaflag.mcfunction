...
execute as @e[type=#mobs,type=!player,predicate=!lbc:nexus] run damage @s 6 cactus
execute as @a[tag=!nomagic_active,tag=!spectator,predicate=!lbc:nexus] run damage @s 6 cactus by @p[tag=caster,gamemode=!spectator]
