...
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"bassboost": true}}}}] mana >= bass_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/basscast_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"enderwand": true}}}}] mana >= ender_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/endcast_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"corrupter": true}}}}] mana >= corruption_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/corrupter_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"lifestealer": true}}}}] mana >= vampire_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/lifestealer_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"foxusing": true}}}}] mana >= confuse_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/foxuscast_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"bloodmagic": true}}}}] mana >= blood_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/bloodmagic_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"badwiki": true}}}}] mana >= bad_wiki_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/badwiki_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"unstable_spellbook": true}}}}] mana >= unstable_spellbook_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/random_spell
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"psychowand": true}}}}] mana >= psycho_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/psychowand_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"omegaflag": true}}}}] mana >= absurd_singularity_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/omegaflag_pre
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"neutralmage": true}}}}] mana >= neutral_wand_mana_use lbc.math unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/neutralmage/select_pre
...
execute if score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cyberkatana": true}}}}] swordcharged1 matches 1.. unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run function lbc:workingitems/cyberkatanaability
...
execute unless score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"corrupter_old": true}}}}] coldown_corrupt matches 901.. at @s run function lbc:workingitems/corrupter_old
execute unless score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"lifestealer_old": true}}}}] coldown_vampire matches 971.. at @s run function lbc:workingitems/lifestealer_old
execute unless score @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"foxusing_old": true}}}}] coldown_foxus matches 921.. at @s run function lbc:workingitems/foxuscast_old
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{multiply:5b}}}}] run function lbc:swrg_kit_integration/items/multiply_5
