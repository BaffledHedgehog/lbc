execute anchored eyes run summon minecraft:arrow ^ ^ ^-.2 {SoundEvent:"block.azalea_leaves.break",damage:0.5d,Tags:["razorpine","prestart2","killedarrow"]}
...
execute store result score #pos0 lbc.math run data get entity @e[type=minecraft:marker,tag=reikast,limit=1] Pos[0] 2000
execute store result score #pos1 lbc.math run data get entity @e[type=minecraft:marker,tag=reikast,limit=1] Pos[1] 2000
execute store result score #pos2 lbc.math run data get entity @e[type=minecraft:marker,tag=reikast,limit=1] Pos[2] 2000
...
execute anchored eyes run summon minecraft:arrow ^ ^ ^-.2 {SoundEvent:"block.azalea_leaves.break",damage:0.5d,Tags:["razorpine","prestart2","killedarrow"]}
execute anchored eyes positioned ^ ^ ^-0.2 run data modify entity @e[type=minecraft:arrow,distance=..3,tag=prestart2,limit=1] Owner set from entity @s UUID
execute anchored eyes positioned ^ ^ ^-0.2 store result entity @e[type=minecraft:arrow,distance=..0.1,tag=prestart2,limit=1] Rotation[0] float -1 run data get entity @s Rotation[0]
execute anchored eyes positioned ^ ^ ^-0.2 store result entity @e[type=minecraft:arrow,distance=..0.1,tag=prestart2,limit=1] Rotation[1] float -1 run data get entity @s Rotation[1]
