execute store result score tmp lbc.math run clear @s minecraft:repeating_command_block[minecraft:custom_data~{heall:1}] 0
...
execute if score @s y matches ..-100000 if score tmp lbc.math matches 10.. run advancement grant @s only lbc:true_advancements/accesories/regeneration_belt