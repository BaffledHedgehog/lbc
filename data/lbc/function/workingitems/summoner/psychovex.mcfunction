...
execute if entity @s[team=17] run team join 17 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=18] run team join 18 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=19] run team join 19 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=20] run team join 20 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=21] run team join 21 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=22] run team join 22 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=23] run team join 23 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=24] run team join 24 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=25] run team join 25 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=26] run team join 26 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=27] run team join 27 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=28] run team join 28 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=29] run team join 29 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=30] run team join 30 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=31] run team join 31 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
execute if entity @s[team=32] run team join 32 @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1]
...
scoreboard players operation @e[type=#minecraft:mobs,tag=summoned_cultist,tag=!summactivated,sort=nearest,limit=1] team_number = @s team_number
