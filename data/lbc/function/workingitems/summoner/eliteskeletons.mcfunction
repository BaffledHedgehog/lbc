...
execute rotated ~ 0 run summon skeleton ^1 ^ ^ {HandDropChances:[0.000F,0.000F],PersistenceRequired:1b,DeathLootTable:"none",Tags:["summeliteskeleton"],HandItems:[{id:"minecraft:diamond_sword",Count:1b},{}],ArmorItems:[{id:"minecraft:diamond_boots",Count:1b},{id:"minecraft:diamond_leggings",Count:1b},{id:"minecraft:diamond_chestplate",Count:1b},{id:"minecraft:diamond_helmet",Count:1b,components:{Unbreakable:1b}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.movement_speed",Base:0.3}]}
execute rotated ~ 0 run summon skeleton ^-1 ^ ^ {HandDropChances:[0.000F,0.000F],PersistenceRequired:1b,DeathLootTable:"none",Tags:["summeliteskeleton"],HandItems:[{id:"minecraft:diamond_sword",Count:1b},{}],ArmorItems:[{id:"minecraft:diamond_boots",Count:1b},{id:"minecraft:diamond_leggings",Count:1b},{id:"minecraft:diamond_chestplate",Count:1b},{id:"minecraft:diamond_helmet",Count:1b,components:{Unbreakable:1b}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.movement_speed",Base:0.3}]}
