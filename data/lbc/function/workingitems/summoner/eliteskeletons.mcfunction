...
execute rotated ~ 0 run summon minecraft:skeleton ^1 ^ ^ {PersistenceRequired:1b,DeathLootTable:"empty",Tags:["summeliteskeleton"],equipment:{mainhand:{id:"minecraft:diamond_sword",count:1},feet:{id:"minecraft:diamond_boots",count:1},legs:{id:"minecraft:diamond_leggings",count:1},chest:{id:"minecraft:diamond_chestplate",count:1},head:{id:"minecraft:diamond_helmet",components:{"minecraft:unbreakable":{}},count:1}},drop_chances:{head:0.0f,chest:0.0f,legs:0.0f,feet:0.0f,mainhand:0.0f,offhand:0.0f},attributes:[{id:"minecraft:follow_range",base:200},{id:"minecraft:movement_speed",base:0.3}]}
execute rotated ~ 0 run summon minecraft:skeleton ^-1 ^ ^ {PersistenceRequired:1b,DeathLootTable:"empty",Tags:["summeliteskeleton"],equipment:{mainhand:{id:"minecraft:diamond_sword",count:1},feet:{id:"minecraft:diamond_boots",count:1},legs:{id:"minecraft:diamond_leggings",count:1},chest:{id:"minecraft:diamond_chestplate",count:1},head:{id:"minecraft:diamond_helmet",components:{"minecraft:unbreakable":{}},count:1}},drop_chances:{head:0.0f,chest:0.0f,legs:0.0f,feet:0.0f,mainhand:0.0f,offhand:0.0f},attributes:[{id:"minecraft:follow_range",base:200},{id:"minecraft:movement_speed",base:0.3}]}
