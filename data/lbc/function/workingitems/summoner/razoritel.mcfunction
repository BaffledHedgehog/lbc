...
execute rotated ~ 0 run summon ravager ^ ^ ^4 {Health:40f,PersistenceRequired:1b,DeathLootTable:"empty",Tags:["summravager"],attributes:[{id:"minecraft:generic.follow_range",base:200}]}
