...
execute as @e[type=#minecraft:mobs,distance=..20,tag=!spectator] if score @s team_number = @e[type=#minecraft:mobs,distance=..20,tag=caster,limit=1] team_number run tag @s add nodmg
