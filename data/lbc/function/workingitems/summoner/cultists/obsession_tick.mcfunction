...
execute unless entity @s[tag=syringe_buffed] run scoreboard players add @e[type=#minecraft:mobs,distance=..2.5,tag=!spectator,tag=!nodmg] twitching 5
execute if entity @s[tag=syringe_buffed] run scoreboard players add @e[type=#minecraft:mobs,distance=..2.5,tag=!spectator,tag=!nodmg] twitching 15
