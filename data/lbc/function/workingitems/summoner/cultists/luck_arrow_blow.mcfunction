...
execute positioned ~ ~1 ~ as @e[type=minecraft:arrow,tag=herrington_arrow,tag=!active,distance=..0.01,limit=4] at @s run function lbc:workingitems/summoner/cultists/luck_arrow_blow_at
