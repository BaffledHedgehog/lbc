...
execute anchored eyes positioned ^ ^ ^ run scoreboard players operation @e[type=minecraft:marker,distance=..0.001,tag=raycastterra,tag=!actived,limit=1] team_number = @s team_number
