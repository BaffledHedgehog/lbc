execute at @s facing entity @e[type=#minecraft:mobs,predicate=!lbc:same_id,predicate=!lbc:same_team,tag=!spectator,sort=nearest,limit=1,tag=!strict_map_object] feet run tp @s ~ ~ ~ ~ ~
