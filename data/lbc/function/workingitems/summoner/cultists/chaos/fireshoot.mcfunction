...
execute as @e[type=minecraft:fireball,distance=..0.001,tag=rc_vp,tag=!actived,limit=1] facing entity @e[type=#minecraft:mobs,distance=0.001..50,tag=!nodmg,tag=!spectator,sort=nearest,limit=1,tag=!strict_map_object] eyes run function lbc:raycast_vpered_slow
