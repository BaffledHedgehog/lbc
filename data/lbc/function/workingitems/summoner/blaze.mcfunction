...
execute if entity @s[team=17] run kill @e[type=minecraft:blaze,tag=summblaze,team=17]
execute if entity @s[team=18] run kill @e[type=minecraft:blaze,tag=summblaze,team=18]
execute if entity @s[team=19] run kill @e[type=minecraft:blaze,tag=summblaze,team=19]
execute if entity @s[team=20] run kill @e[type=minecraft:blaze,tag=summblaze,team=20]
execute if entity @s[team=21] run kill @e[type=minecraft:blaze,tag=summblaze,team=21]
execute if entity @s[team=22] run kill @e[type=minecraft:blaze,tag=summblaze,team=22]
execute if entity @s[team=23] run kill @e[type=minecraft:blaze,tag=summblaze,team=23]
execute if entity @s[team=24] run kill @e[type=minecraft:blaze,tag=summblaze,team=24]
execute if entity @s[team=25] run kill @e[type=minecraft:blaze,tag=summblaze,team=25]
execute if entity @s[team=26] run kill @e[type=minecraft:blaze,tag=summblaze,team=26]
execute if entity @s[team=27] run kill @e[type=minecraft:blaze,tag=summblaze,team=27]
execute if entity @s[team=28] run kill @e[type=minecraft:blaze,tag=summblaze,team=28]
execute if entity @s[team=29] run kill @e[type=minecraft:blaze,tag=summblaze,team=29]
execute if entity @s[team=30] run kill @e[type=minecraft:blaze,tag=summblaze,team=30]
execute if entity @s[team=31] run kill @e[type=minecraft:blaze,tag=summblaze,team=31]
execute if entity @s[team=32] run kill @e[type=minecraft:blaze,tag=summblaze,team=32]
...
execute if entity @s[team=17] run team join 17 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=18] run team join 18 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=19] run team join 19 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=20] run team join 20 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=21] run team join 21 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=22] run team join 22 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=23] run team join 23 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=24] run team join 24 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=25] run team join 25 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=26] run team join 26 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=27] run team join 27 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=28] run team join 28 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=29] run team join 29 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=30] run team join 30 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=31] run team join 31 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
execute if entity @s[team=32] run team join 32 @e[type=minecraft:blaze,tag=summblaze,tag=!summactivated,sort=nearest,limit=3]
