...
summon guardian ~ ~1 ~3 {NoGravity:1b,PersistenceRequired:1b,DeathLootTable:"none",Tags:["summguardians"],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.knockback_resistance",Base:100}]}
summon guardian ~ ~1 ~-3 {NoGravity:1b,PersistenceRequired:1b,DeathLootTable:"none",Tags:["summguardians"],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.knockback_resistance",Base:100}]}
summon guardian ~3 ~1 ~ {NoGravity:1b,PersistenceRequired:1b,DeathLootTable:"none",Tags:["summguardians"],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.knockback_resistance",Base:100}]}
summon guardian ~-3 ~1 ~ {NoGravity:1b,PersistenceRequired:1b,DeathLootTable:"none",Tags:["summguardians"],Attributes:[{Name:"generic.follow_range",Base:200},{Name:"generic.knockback_resistance",Base:100}]}
