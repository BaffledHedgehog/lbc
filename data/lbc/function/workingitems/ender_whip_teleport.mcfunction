execute store result score tmp lbc.math run data get entity @s SelectedItem.tag.teleportid
particle portal ~ ~0.81 ~ 0 0.5 0 0.5 50 force
playsound entity.enderman.teleport master @a ~ ~ ~ 1 1
execute store result score @s lbcID run data get entity @s SelectedItem.tag.teleportid
tag @s add tp
