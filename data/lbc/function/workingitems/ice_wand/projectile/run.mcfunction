particle dust 0.408 0.69 0.922 1 ~ ~ ~ 0.1 0.1 0.1 0 1 force
particle snowflake ~ ~ ~ 0.1 0.1 0.1 0 1 force
schedule function lbc:workingitems/ice_wand/projectile/tick 1t
execute positioned ~ ~-0.25 ~ unless entity @e[type=snowball,limit=1,distance=..0.01] run function lbc:workingitems/ice_wand/projectile/impact/run with entity @s item.tag
