summon snowball ~ ~ ~ {Item:{id:"repeating_command_block",Count:1b,components:{"minecraft:custom_model_data":617}},Tags:["magic","ice_projectile","new"]}
data modify entity @e[tag=ice_projectile,limit=1,tag=new,type=snowball,distance=..2] Owner set from entity @s UUID
execute positioned 0 4000 0 run summon item_display ~ ~ ~ {Tags:["new","ice_projectile","magic"],item:{id:"repeating_command_block",Count:1b,components:{"minecraft:custom_model_data":622}}}
