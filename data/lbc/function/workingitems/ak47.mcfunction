execute anchored eyes positioned ^ ^ ^ run summon arrow ~ ~ ~ {Tags:["stalin_arrow_player"],damage:0.001,item:{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:dolphins_grace",amplifier:104b,duration:2}]}}}}
