...
execute if entity @e[type=#mobs,tag=!spectator,distance=..1] if predicate lbc:chance20 run function lbc:workingitems/corrupted_pentagram/ahriman_exploded
execute if block ~ ~-0.5 ~ #airs run function lbc:workingitems/corrupted_pentagram/ahriman_exploded
execute unless block ~ ~0.5 ~ #airs run function lbc:workingitems/corrupted_pentagram/ahriman_exploded