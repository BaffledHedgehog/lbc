...
execute as @e[type=#minecraft:mobs,type=!#minecraft:unholy_monsters,type=!minecraft:player,distance=..16,tag=!strict_map_object] facing entity @s eyes positioned as @s run function lbc:raycast_vpered_slow_vect
