...
execute store result score @s lbcID run data get entity @s Inventory[{Slot:-106b}].components.minecraft:attribute_modifiers.modifiers[{type: "minecraft:zombie.spawn_reinforcements"}].amount 1
