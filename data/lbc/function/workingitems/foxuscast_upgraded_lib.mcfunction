...
execute if score spell lbc.math matches 22 run effect give @e[distance=0.1..10,tag=!spectator] minecraft:slowness 3 50 true
...
execute if score spell lbc.math matches 22 run tellraw @a[gamemode=!spectator,distance=0.01..10] [{"translate":"player_stopped","color":"aqua"}]
...
execute if score spell lbc.math matches 24 run effect give @a[gamemode=!spectator,distance=0.01..10] minecraft:blindness 6 0 true
execute if score spell lbc.math matches 24 run tellraw @a[gamemode=!spectator,distance=0.01..10] {"translate":"player_blinded","color":"gray"}
