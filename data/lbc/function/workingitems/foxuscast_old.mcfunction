...
execute if score #random4 lbc.math matches 4 run effect give @e[distance=0.1..10,tag=!spectator] blindness 6 0 true
...
execute if score #random4 lbc.math matches 2 run effect give @e[distance=0.1..10] slowness 3 50 true
