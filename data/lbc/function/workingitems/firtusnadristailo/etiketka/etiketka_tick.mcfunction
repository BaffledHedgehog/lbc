...
function lbc:workingitems/firtusnadristailo/etiketka/etiketka_detect_rec
execute unless entity @s run return run tag @a remove nodmg
execute unless entity @s run return run tag @a remove nodmg1
execute at @s run function lbc:workingitems/firtusnadristailo/etiketka/etiketka_detect_rec
execute unless entity @s run return run tag @a remove nodmg
execute unless entity @s run return run tag @a remove nodmg1
execute at @s run function lbc:workingitems/firtusnadristailo/etiketka/etiketka_detect_rec
