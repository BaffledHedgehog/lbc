...
execute if entity @e[type=minecraft:arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:arrow ^0.4 ^ ^0.3 {Tags:["doubel","killedarrow"]}
execute if entity @e[type=minecraft:arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:arrow ^-0.4 ^ ^0.3 {Tags:["doubel","killedarrow"]}
execute if entity @e[type=minecraft:spectral_arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:spectral_arrow ^0.4 ^ ^0.3 {Tags:["doubel","killedarrow"]}
execute if entity @e[type=minecraft:spectral_arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:spectral_arrow ^-0.4 ^ ^0.3 {Tags:["doubel","killedarrow"]}
