...
execute as @e[type=#arrows,tag=doubel,limit=2,distance=..1,tag=!active] run data modify entity @s Color set from entity @e[type=#arrows,distance=..1,limit=1,tag=doublearrow] Color
execute as @e[type=#arrows,tag=doubel,limit=2,distance=..1,tag=!active] run data modify entity @s custom_potion_effects set from entity @e[type=#arrows,distance=..1,limit=1,tag=doublearrow] custom_potion_effects
