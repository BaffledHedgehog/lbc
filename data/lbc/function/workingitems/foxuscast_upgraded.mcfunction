...
execute if score #mode lbc.math matches 4 run tellraw @a[distance=0.01..10,gamemode=!spectator] {"translate":"player_blinded","color":"gray"}
execute if score #mode lbc.math matches 4 run effect give @s levitation 1 10 true
execute if score #mode lbc.math matches 4 run effect give @s slow_falling 8 0 true
...
execute if score #mode lbc.math matches 1 run effect give @s invisibility 10 0 true
...
execute if score #mode lbc.math matches 2 run effect give @e[distance=0.1..10,tag=!spectator] slowness 3 50 true
...
execute if score #mode lbc.math matches 2 run tellraw @a[distance=0.01..10,gamemode=!spectator] [{"translate":"player_stopped","color":"aqua"}]
...
execute if score #mode lbc.math matches 2 run particle minecraft:large_smoke ~ ~1 ~ 1 1 1 0.075 80 force
execute if score #mode lbc.math matches 3 run effect give @s speed 10 3 true
execute if score #mode lbc.math matches 3 run effect give @s jump_boost 10 3 true
