...
execute if score #mode lbc.math matches 4 run effect give @a[gamemode=!spectator,distance=0.01..10,predicate=!lbc:same_team] minecraft:blindness 6 0 true
execute if score #mode lbc.math matches 4 run tellraw @a[gamemode=!spectator,distance=0.01..10,predicate=!lbc:same_team] {"translate":"player_blinded","color":"gray"}
...
execute if score #mode lbc.math matches 2 run effect give @e[distance=0.1..10,tag=!spectator,predicate=!lbc:same_team] minecraft:slowness 3 50 true
...
execute if score #mode lbc.math matches 2 run tellraw @a[gamemode=!spectator,distance=0.01..10,predicate=!lbc:same_team] [{"translate":"player_stopped","color":"aqua"}]
