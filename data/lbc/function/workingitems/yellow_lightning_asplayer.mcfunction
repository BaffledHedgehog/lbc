execute if entity @s[type=minecraft:player] run particle minecraft:item{item:{id:"minecraft:repeating_command_block",components:{"minecraft:item_model":"lbc:piss"}}} ~ ~ ~ 0.3 0.2 0.3 0 200 force @s
