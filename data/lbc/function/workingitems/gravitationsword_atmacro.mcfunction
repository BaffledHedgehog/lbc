...
$attribute @s fall_damage_multiplier modifier add gravity_curse $(t1) add_multiplied_total
$attribute @s gravity modifier add gravity_curse $(t2) add_multiplied_total
$attribute @s step_height modifier add gravity_curse $(t3) add_multiplied_total
$attribute @s safe_fall_distance modifier add gravity_curse $(t4) add_multiplied_total
$attribute @s minecraft:jump_strength modifier add gravity_curse $(t5) add_multiplied_total
$attribute @s movement_speed modifier add gravity_curse $(t6) add_multiplied_total
