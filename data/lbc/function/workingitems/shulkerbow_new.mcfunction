...
# Summoning
execute anchored eyes positioned ^ ^ ^ as @e[type=#minecraft:arrows,tag=shulkerarrow,sort=nearest,limit=1] run summon minecraft:shulker_bullet ~ ~ ~ {Tags:["shulk"],NoGravity:true}
...
execute if score tmp lbc.math matches 113 anchored eyes positioned ^ ^ ^ run data modify entity @e[tag=shulk,sort=nearest,limit=1] NoGravity set value false
