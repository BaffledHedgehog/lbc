...
function lbc:tick10t
function lbc:tick1s
execute if predicate lbc:chance50 run function lbc:tick2s
execute if predicate lbc:chance35 run function lbc:tick3s
execute if predicate lbc:chance25 run function lbc:tick4s
