...
execute if score @s bass_combo_len = tmp lbc.math run function lbc:workingitems/basscast_combo_succesful_less
execute if score @s bass_combo_len = tmp1 lbc.math run function lbc:workingitems/basscast_combo_succesful
execute if score @s bass_combo_len = tmp-1 lbc.math run function lbc:workingitems/basscast_combo_succesful_less
