...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:3}}}}] run particle minecraft:flash{color:[1,1,1,1]} ~ ~1 ~ 10 10 10 0 100 force
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:7}}}}] run effect give @e[distance=0.1..4,predicate=!lbc:same_team] minecraft:levitation 1 7
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:9}}}}] run effect give @e[distance=0.1..4,predicate=!lbc:same_team] minecraft:blindness 3 1
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:11}}}}] run playsound minecraft:entity.ghast.hurt master @a[distance=0.1..15,predicate=!lbc:same_team] ~ ~ ~ 1000000 0
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:11}}}}] as @a[distance=0.1..15,predicate=!lbc:same_team] at @s run particle minecraft:elder_guardian ~ ~ ~ 0 0 0 1 1 force @s

execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:12}}}}] as @e[distance=0.1..5,predicate=!lbc:same_team] run playsound minecraft:entity.enderman.teleport master @a[distance=..15] ~ ~ ~ 1 0
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:12}}}}] as @e[distance=0.1..5,predicate=!lbc:same_team] at @s run particle minecraft:portal ~ ~1 ~ 0.3 1 0.3 2 150
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:12}}}}] run spreadplayers ~ ~ 0 20 false @e[distance=0.1..5,predicate=!lbc:same_team]

execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:13}}}}] run effect give @e[distance=0.1..5,predicate=!lbc:same_team] minecraft:weakness 6 0
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{cooltype:16}}}}] run effect give @e[distance=0.5..10,predicate=!lbc:same_team] minecraft:instant_damage 1 0
