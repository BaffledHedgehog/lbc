execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":0}}}}] run effect give @s resistance 5 1
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":0}}}}] run particle minecraft:block{block_state:"iron_block"} ~ ~1 ~ 0.3 1 0.3 0 45 force
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":1}}}}] run effect give @s regeneration 1 99
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":2}}}}] run effect give @s fire_resistance 16 0
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":3}}}}] run effect give @s speed 2 2
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":5}}}}] run effect give @s invisibility 20 1 true
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run particle end_rod ~ ~1 ~ 0.3 1 0.3 0.1 40 force
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~ ~1.62 ~1 {Motion:[0.0,0.0,8.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~ ~1.62 ~-1 {Motion:[0.0,0.0,-8.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~1 ~1.62 ~ {Motion:[8.0,0.0,0.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~-1 ~1.62 ~ {Motion:[-8.0,0.0,0.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~1 ~1.62 ~1 {Motion:[8.0,0.0,8.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~-1 ~1.62 ~-1 {Motion:[-8.0,0.0,-8.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~1 ~1.62 ~-1 {Motion:[8.0,0.0,-8.0],PierceLevel:10b,Tags:["killedarrow"]}
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":6}}}}] run summon arrow ~-1 ~1.62 ~1 {Motion:[-8.0,0.0,8.0],PierceLevel:10b,Tags:["killedarrow"]}
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":7}}}}] run particle sneeze ~ ~0.1 ~ 3 0.1 3 0 140 force
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":7}}}}] run effect give @s jump_boost 10 2
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":7}}}}] run effect give @e[distance=0.1..4] levitation 1 7
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":8}}}}] run effect give @s resistance 1 4 true
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":8}}}}] run summon creeper ^ ^ ^-0.5 {ExplosionRadius:1b,Fuse:0,ignited:1b}
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":9}}}}] run effect give @s glowing 3 1
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":9}}}}] run effect give @e[distance=0.1..4] blindness 3 1
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":9}}}}] run particle smoke ~ ~1 ~ 3 0.3 3 0 200 force
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":10}}}}] run effect give @s strength 5 0
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":12}}}}] as @e[distance=0.1..5] at @s run particle portal ~ ~1 ~ 0.3 1 0.3 2 150
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":13}}}}] run effect give @e[distance=0.1..5] weakness 6 0
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":13}}}}] run particle falling_nectar ~ ~2 ~ 4 0.1 4 0.1 350 force
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":14}}}}] run effect give @s conduit_power 4 1
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":15}}}}] run effect give @s absorption 30 1
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":16}}}}] run effect give @e[distance=0.5..10] instant_damage 1 0
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"cooltype":16}}}}] run particle damage_indicator ~ ~2 ~ 10 5 10 0 400 force
