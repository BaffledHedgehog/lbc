...
execute anchored eyes positioned ^ ^ ^ store result score tmp lbc.math run data get entity @e[type=#arrows,distance=..6,limit=1,sort=nearest] custom_potion_effects[{id:"minecraft:dolphins_grace"}].amplifier
...
execute anchored eyes positioned ^ ^ ^ if score tmp lbc.math matches 0 if entity @e[type=#arrows,distance=..6,limit=1,sort=nearest,nbt={custom_potion_effects:[{}]}] run function lbc:workingitems/railgun_bow_effect_store
execute anchored eyes positioned ^ ^ ^ if score tmp lbc.math matches 0 if data entity @e[type=#arrows,distance=..6,limit=1,sort=nearest] Potion run function lbc:workingitems/railgun_bow_effect_store_glackmojumba
