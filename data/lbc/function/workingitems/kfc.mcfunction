execute anchored eyes run summon chicken ^ ^ ^1 {Health:30f,Attributes:[{Name:"generic.max_health",Base:30}],Fire:2000,HasVisualFire:1b,DeathLootTable:"none",Age:-19980,EggLayTime:1999980,Tags:["chick","notstarted","lucky_mob"]}
