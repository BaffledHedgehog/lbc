execute anchored eyes run summon chicken ^ ^ ^1 {Health:30f,attributes:[{id:"generic.max_health",base:30}],Fire:2000,HasVisualFire:1b,DeathLootTable:"empty",Age:-19980,EggLayTime:1999980,Tags:["chick","notstarted","lucky_mob"]}
