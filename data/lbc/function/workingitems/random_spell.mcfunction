execute store result score #random53 lbc.math run random value 1..55
tag @s add raycaster
...
execute if score #random53 lbc.math matches 55 anchored eyes positioned ^ ^ ^ run function lbc:items/wands/sauvojen_wand/cast_2
