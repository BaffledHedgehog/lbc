...
execute as @e[type=minecraft:arrow,tag=vex_arrow,tag=!active] at @s facing entity @e[type=#minecraft:mobs,distance=..10,tag=!nodamagevex,tag=!spectator,nbt=!{HurtTime:0s}] eyes run function lbc:raycast_vpered_slow
