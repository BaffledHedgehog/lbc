...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{upgradable:1}}}}] if score #random4 lbc.math matches 2 if entity @s[nbt={active_effects:[{id:"minecraft:slow_falling"},{id:"minecraft:speed"},{id:"minecraft:jump_boost"},{id:"minecraft:invisibility"}]}] if entity @e[type=#minecraft:mobs,distance=0.01..15,limit=1,nbt={active_effects:[{id:"minecraft:blindness"},{id:"minecraft:slowness"}]}] run function lbc:other/magic_academy/can_upgrade