...
execute if entity @s[nbt={SelectedItem:{components:{upgradable:1b}}},predicate=lbc:sneak] run function lbc:workingitems/sauvojen_staffs/teleport_preloop_upgrade
