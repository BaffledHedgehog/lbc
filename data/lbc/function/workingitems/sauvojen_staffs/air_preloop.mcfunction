...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"upgradable": true}}}}] run tag @e[tag=raycasttnt,tag=!actived,limit=1,distance=..0.0001] add check_distance
