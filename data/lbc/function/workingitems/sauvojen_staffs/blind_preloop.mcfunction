...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"upgradable": true}}}}] run tag @e[tag=raycastblindwand,tag=!actived,limit=5,distance=..0.2] add check_distance
