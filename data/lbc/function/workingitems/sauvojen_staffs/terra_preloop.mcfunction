...
summon minecraft:marker ^ ^ ^ {data:{lifetime:200},Tags:["raycastterra","player","slowraycast","shield_blockable2","magic"]}
data modify entity @e[type=minecraft:marker,distance=..0.0001,tag=raycastterra,tag=!actived,limit=1] Rotation set from entity @s Rotation
