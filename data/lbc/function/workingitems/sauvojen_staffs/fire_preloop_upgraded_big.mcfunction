...
data modify entity @e[type=minecraft:fireball,distance=..4,tag=stwandfireball,tag=!activated,limit=1] acceleration_power set from entity @e[type=minecraft:marker,tag=reikast,limit=1] Pos
