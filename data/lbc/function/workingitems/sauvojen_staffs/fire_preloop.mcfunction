...
data modify entity @e[type=small_fireball,distance=..4,tag=!activated,tag=stwandfireball,limit=1] Motion set from entity @e[type=marker,tag=reikast,limit=1] Pos
