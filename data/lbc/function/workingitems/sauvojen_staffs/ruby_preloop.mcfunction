...
execute if entity @s[nbt={SelectedItem:{components:{upgradable:1b}}},predicate=lbc:sneak] run function lbc:workingitems/sauvojen_staffs/ruby_preloop_check_upgrade