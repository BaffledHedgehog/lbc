effect give @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{upgraded:1}}}}] minecraft:slow_falling 3 0 true
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{upgradable:1}}}}] if score @s falltimer matches 100.. run function lbc:other/magic_academy/can_upgrade
