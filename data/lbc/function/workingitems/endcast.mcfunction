effect give @s[nbt={SelectedItem:{components: {"minecraft:custom_data":{upgraded:1b}}}}] slow_falling 3 0 true
...
execute if entity @s[nbt={SelectedItem:{components: {"minecraft:custom_data":{"upgradable": true}}}}] if score @s falltimer matches 100.. run function lbc:other/magic_academy/can_upgrade
