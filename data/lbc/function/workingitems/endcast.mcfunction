...
execute if entity @s[nbt={SelectedItem:{components: {"minecraft:custom_data":{upgradable:1b}}}}] if score @s falltimer matches 100.. run function lbc:other/magic_academy/can_upgrade
