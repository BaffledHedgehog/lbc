...
spreadplayers ~ ~ 0 10 false @e[distance=..10,nbt={HurtTime:10s},predicate=!lbc:the_nether]
spreadplayers ~ ~ 0 10 under 120 false @e[distance=..10,nbt={HurtTime:10s},predicate=lbc:the_nether]
