...
data modify block 10241024 100 10241024 Items.[{Slot:5b}].tag.teleportid set from entity @e[type=#mobs,limit=1,tag=!spectator,distance=0.01..7,nbt={HurtTime:10s},sort=nearest] UUID[0]
