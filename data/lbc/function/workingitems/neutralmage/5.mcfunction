execute anchored eyes positioned ^ ^ ^1 run summon potion ~ ~ ~ {Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:potion_contents":{custom_color:16719841,custom_effects:[{id:"minecraft:weakness",amplifier:3b,duration:60},{id:"minecraft:poison",amplifier:3b,duration:60},{id:"minecraft:wither",amplifier:3b,duration:60},{id:"minecraft:glowing",amplifier:3b,duration:60}]}}}}
...
execute anchored eyes positioned ^.1 ^ ^1 run summon potion ~ ~ ~ {Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:potion_contents":{custom_color:16719841,custom_effects:[{id:"minecraft:weakness",amplifier:3b,duration:60},{id:"minecraft:poison",amplifier:3b,duration:60},{id:"minecraft:wither",amplifier:3b,duration:60},{id:"minecraft:glowing",amplifier:3b,duration:60}]}}}}
