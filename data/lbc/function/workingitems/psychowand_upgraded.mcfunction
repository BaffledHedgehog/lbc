...
execute if score #mode lbc.math matches 4 as @e[type=#minecraft:mobs,distance=0.01..30,tag=!nomagic_active,tag=!spectator] at @s run function lbc:workingitems/psychowand/scare
