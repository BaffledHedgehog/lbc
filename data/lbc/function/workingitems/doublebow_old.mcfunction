...
execute if entity @e[type=minecraft:arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:arrow ^-1 ^ ^0.3 {Tags:["doubel","killedarrow"]}
execute if entity @e[type=minecraft:spectral_arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:spectral_arrow ^1.3 ^1.6 ^ {Tags:["doubel"]}
execute if entity @e[type=minecraft:spectral_arrow,distance=..3,tag=doublearrow,limit=1] run summon minecraft:spectral_arrow ^-1.3 ^1.6 ^ {Tags:["doubel"]}
# Set those 2 arrows Motion from first arrow
execute as @e[type=#minecraft:arrows,distance=..3,tag=doubel,tag=!active,limit=2] run data modify entity @s Owner set from entity @p[gamemode=!spectator,scores={bow=1..}] UUID
