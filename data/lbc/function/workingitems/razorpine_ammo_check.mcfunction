...
execute store success score temp_check lbc.math run clear @s #minecraft:razor_ammo_best 1
execute unless score temp_check lbc.math matches 1 store success score temp_check_2 lbc.math run clear @s #minecraft:razor_ammo 1
