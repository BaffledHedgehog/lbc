...
execute unless entity @s[tag=have_stand,tag=stand_clocks_active] as @e[type=#mobs,distance=0.01..20,tag=!nomagic_active,tag=!spectator] run damage @s 1 arrow
execute if entity @s[tag=have_stand,tag=stand_clocks_active,scores={overheaven=..0}] as @e[type=#mobs,distance=0.01..20,tag=!nomagic_active,tag=!spectator] run damage @s 5 arrow
execute if entity @s[tag=have_stand,tag=stand_clocks_active,scores={overheaven=1..}] as @e[type=#mobs,distance=0.01..20,tag=!nomagic_active,tag=!spectator] run damage @s 10 arrow
