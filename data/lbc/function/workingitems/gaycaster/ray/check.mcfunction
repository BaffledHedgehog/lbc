...
execute if entity @e[distance=..5,dx=0,dy=0,dz=0,type=#mobs,limit=1,tag=!caster] run function lbc:workingitems/gaycaster/ray/impact/entity/run with storage lbc:gaycaster color
