...
execute if score @s h matches 330..359 if entity @e[type=#mobs,distance=..1.5,tag=!caster] run advancement grant @s only lbc:true_advancements/staffs/gaycaster r
execute if score @s h matches 0..20 if entity @e[type=#mobs,distance=..1.5,tag=!caster] run advancement grant @s only lbc:true_advancements/staffs/gaycaster r
execute if score @s h matches 21..72 if entity @e[type=#mobs,distance=..1.5,tag=!caster] run advancement grant @s only lbc:true_advancements/staffs/gaycaster o
execute if score @s h matches 73..124 if entity @e[type=#mobs,distance=..1.5,tag=!caster] run advancement grant @s only lbc:true_advancements/staffs/gaycaster y
execute if score @s h matches 125..175 if entity @e[type=#mobs,distance=..1.5,tag=!caster] run advancement grant @s only lbc:true_advancements/staffs/gaycaster g
