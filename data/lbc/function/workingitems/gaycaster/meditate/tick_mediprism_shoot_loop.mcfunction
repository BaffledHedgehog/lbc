...
execute as @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..5,tag=!spectator,tag=!hit,limit=1] positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0,dy=0,dz=0] at @s run function lbc:workingitems/gaycaster/meditate/tick_mediprism_shoot_loop_dmg
