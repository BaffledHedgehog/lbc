...
execute if score @a[limit=1,distance=..0.001,gamemode=!spectator] hplvl < @s hplvl run effect give @a[limit=1,distance=..0.001,gamemode=!spectator] instant_health 1 99 false