tag @s add cloned
summon ghast ~ ~ ~ {Tags:["white_whale_clone","lucky_mob"],PersistenceRequired:1b,Health:15000f,ExplosionPower:30,CustomName:'{"translate":"white_whale","italic":false}',attributes:[{id:"minecraft:generic.max_health",base:15000},{id:"minecraft:generic.follow_range",base:200}]}
summon ghast ~ ~ ~ {Tags:["white_whale_clone","lucky_mob"],PersistenceRequired:1b,Health:15000f,ExplosionPower:30,CustomName:'{"translate":"white_whale","italic":false}',attributes:[{id:"minecraft:generic.max_health",base:15000},{id:"minecraft:generic.follow_range",base:200}]}
summon ghast ~ ~ ~ {Tags:["white_whale_clone","lucky_mob"],PersistenceRequired:1b,Health:15000f,ExplosionPower:30,CustomName:'{"translate":"white_whale","italic":false}',attributes:[{id:"minecraft:generic.max_health",base:15000},{id:"minecraft:generic.follow_range",base:200}]}
tp @s 0 150 0
