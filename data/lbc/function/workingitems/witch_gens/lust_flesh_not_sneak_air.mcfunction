...
summon ender_dragon ^ ^ ^3 {Tags:["lust_dragon","lucky_mob"],PersistenceRequired:1b,Health:20f,CustomName:'{"translate":"lust_dragon","italic":false}',attributes:[{id:"generic.max_health",base:20},{id:"generic.follow_range",base:200}],DragonPhase:1}
