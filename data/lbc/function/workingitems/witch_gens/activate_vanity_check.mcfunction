...
tellraw @s[tag=!sin_vanity] [{"translate":"dmg_dealt","color":"light_purple"},{"score":{"objective":"lbc.math","name":"#tmpl"},"type":"score"},{"translate":"lives_count"},{"score":{"objective":"swrg.lives","name":"@s"},"type":"score"},{"translate":"game_time"},{"score":{"objective":"lbc.math","name":"#timer"},"type":"score"}]