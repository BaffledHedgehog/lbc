...
tp @s ^ ^ ^.3
particle dust{color:[0.188, 0.035, 0.192],scale:3} ~ ~ ~ 0 0 0 0 1 force @a[tag=sin_indolence]
particle dust{color:[0.188, 0.035, 0.192],scale:3} ~ ~ ~ 0 0 0 0 1 force @a[tag=sin_vanity]
