summon ghast ^ ^ ^10 {Tags:["white_whale","lucky_mob"],PersistenceRequired:1b,Health:5400f,ExplosionPower:30,CustomName:'{"translate":"white_whale","italic":false}',attributes:[{id:"generic.max_health",base:54000},{id:"generic.follow_range",base:200}]}
