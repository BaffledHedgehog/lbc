summon ghast ^ ^ ^10 {Tags:["white_whale","lucky_mob"],PersistenceRequired:1b,Health:5400f,ExplosionPower:30,CustomName:'{"translate":"white_whale","italic":false}',attributes:[{id:"minecraft:generic.max_health",base:54000},{id:"minecraft:generic.follow_range",base:200}]}
