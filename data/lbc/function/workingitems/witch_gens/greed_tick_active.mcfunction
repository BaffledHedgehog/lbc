...
attribute @s minecraft:generic.attack_damage modifier add e916adfe-014b-4ff5-82f1-af6ec9226d21 10 add_value
attribute @s minecraft:generic.knockback_resistance modifier add e916adfe-014b-4ff5-82f1-af6ec9226d21 10000 add_value
