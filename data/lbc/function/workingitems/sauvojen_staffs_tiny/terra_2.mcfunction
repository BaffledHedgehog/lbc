...
execute if predicate lbc:chance30 run particle dust_color_transition 0.01 1 0.134 1 0.004 1 0.137 ~ ~ ~ 0 0 0 0 1 force
playsound block.amethyst_cluster.hit master @a ~ ~ ~ 0.1 2
damage @e[tag=!raycaster,distance=..8,dx=0,dy=0,dz=0,tag=!spectator,limit=1] 2 arrow by @s
