function lbc:workingitems/sauvojen_staffs_tiny/ruby_2
playsound block.amethyst_cluster.break master @a ~ ~ ~ 1 2
scoreboard players operation @s mana -= tiny_ruby_wand_mana_use lbc.math
