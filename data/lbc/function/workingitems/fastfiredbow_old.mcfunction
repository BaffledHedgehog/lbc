...
# Recharging crossbow
item replace entity @s[nbt={Inventory:[{id:"minecraft:arrow"}]}] weapon.mainhand with crossbow{display:{Name:'{"translate":"blaze_crossbow_old","color":"yellow","bold":true,"italic":false}'},fastfired_old:1b,Enchantments:[{id:"minecraft:quick_charge",lvl:5s}],ChargedProjectiles:[{id:"minecraft:arrow",Count:1b},{},{}],Charged:1b} 1
clear @s[nbt={Inventory:[{id:"minecraft:arrow"}]}] arrow 1