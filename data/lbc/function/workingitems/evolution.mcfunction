...
item replace entity @s weapon.mainhand with golden_sword[minecraft:custom_model_data=581,unbreakable={},custom_name='{"translate":"evolution_sword","italic":false}',lore=['{"translate":"evolution_sword.lore.1","color":"white","italic":false}','{"translate":"evolution_sword.lore.2","color":"white","italic":false}'],custom_data={transformable:1b,sword:1b,evolution:1b}]
