...
execute unless score @s lbc.levelup1 matches 100000000.. run scoreboard players set @s lbc.levelup1 100000000
execute unless score @s lbc.levelup2 matches 100000000.. run scoreboard players set @s lbc.levelup2 100000000
execute unless score @s lbc.levelup3 matches 100000000.. run scoreboard players set @s lbc.levelup3 100000000

execute unless score @s lbc.trinket1 matches 100000000.. run scoreboard players set @s lbc.trinket1 100000000
execute unless score @s lbc.trinket2 matches 100000000.. run scoreboard players set @s lbc.trinket2 100000000
execute unless score @s lbc.trinket3 matches 100000000.. run scoreboard players set @s lbc.trinket3 100000000
