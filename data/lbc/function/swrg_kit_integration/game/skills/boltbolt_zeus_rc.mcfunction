...
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..5,tag=!spectator,tag=!nodamage,tag=!nodamage1] run function lbc:swrg_kit_integration/game/skills/boltbolt_zeus_hit
