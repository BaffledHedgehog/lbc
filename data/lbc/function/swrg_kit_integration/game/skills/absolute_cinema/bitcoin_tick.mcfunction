...
execute store success score succ lbc.math as @e[type=#minecraft:mobs,distance=..2,predicate=!lbc:same_team,tag=!spectator] run damage @s 15 falling_block by @e[tag=akyla_devid,type=dolphin,limit=1]
