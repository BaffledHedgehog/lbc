...
execute if entity @s[tag=!oreshnik_splitted] run playsound lbcsounds.rocket_power master @a ~ ~ ~ 1 1 0.5
execute if entity @s[tag=oreshnik_splitted] run playsound lbcsounds.rocket_power master @a ~ ~ ~ 1 1.5 0.08
tp @s ^ ^ ^1
