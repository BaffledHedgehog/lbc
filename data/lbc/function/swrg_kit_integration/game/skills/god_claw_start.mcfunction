...
execute positioned ~ ~-.5 ~ align xyz positioned ~.5 ~.5 ~.5 run summon minecraft:marker ~ ~ ~ {Tags:["slowraycast","player","god_claw","magic"]}
...
execute positioned ~ ~-.5 ~ align xyz positioned ~.5 ~.5 ~.5 run scoreboard players operation @e[type=minecraft:marker,distance=..0.01,tag=god_claw,tag=!spawned,limit=1] team_number = @s team_number
