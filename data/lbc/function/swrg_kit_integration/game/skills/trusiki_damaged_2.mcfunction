...
$execute store result score tmp lbc.math run data get storage lbc.math2 $(tmp) 100
$execute store result score tmp1 lbc.math run data get storage lbc.math2 x$(tmp) 100
