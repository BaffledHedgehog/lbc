execute store result score tmp lbc.math run attribute @s generic.armor base get 10
...
execute store result score tmp lbc.math run attribute @s generic.armor_toughness base get 10
...
execute store result score tmp lbc.math run attribute @s generic.attack_damage base get 10
...
execute store result score tmp lbc.math run attribute @s generic.knockback_resistance base get 1000
...
execute store result score tmp lbc.math run attribute @s generic.movement_speed base get 1000
