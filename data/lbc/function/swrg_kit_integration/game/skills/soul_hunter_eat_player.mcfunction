...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:armor get 10
...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:armor_toughness get 10
scoreboard players operation tmp lbc.math += tmp1 lbc.math
execute store result storage lbcmath tmp double 0.1 run scoreboard players get tmp lbc.math
...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:luck get 1
scoreboard players operation tmp lbc.math += tmp1 lbc.math
...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:max_health get 1
scoreboard players operation tmp lbc.math += tmp1 lbc.math
execute store result storage lbcmath tmp double 1 run scoreboard players get tmp lbc.math
...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:attack_damage get 10
scoreboard players operation tmp lbc.math += tmp1 lbc.math
execute store result storage lbcmath tmp double 0.1 run scoreboard players get tmp lbc.math
...
execute store result score tmp1 lbc.math run attribute @a[gamemode=!spectator,scores={death=1},limit=1] minecraft:knockback_resistance get 1000
scoreboard players operation tmp lbc.math += tmp1 lbc.math
