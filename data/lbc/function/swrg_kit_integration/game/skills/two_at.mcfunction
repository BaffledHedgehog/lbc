...
execute if entity @s[type=minecraft:splash_potion] run summon minecraft:splash_potion ~ ~ ~ {Tags:["doubled","doubledcurr"]}
execute if entity @s[type=minecraft:lingering_potion] run summon minecraft:lingering_potion ~ ~ ~ {Tags:["doubled","doubledcurr"]}
