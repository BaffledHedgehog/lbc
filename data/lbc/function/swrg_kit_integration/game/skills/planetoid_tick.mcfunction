...
execute at @e[type=#mobs,tag=affected_by_gravity,distance=2..15] facing entity @s eyes rotated ~-87 ~ as @e[type=#mobs,type=!player,distance=..0.001,limit=1] run function lbc:raycast_vpered_slow
