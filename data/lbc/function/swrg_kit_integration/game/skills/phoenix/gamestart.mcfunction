...
scoreboard players operation tmp1 lbc.math *= 5 lbc.math
scoreboard players operation tmp1 lbc.math += tmp lbc.math
scoreboard players remove tmp1 lbc.math 5
...
execute if score tmp1 lbc.math matches 2.. run scoreboard players operation @s swrg.lives = tmp1 lbc.math
execute if score tmp1 lbc.math matches ..1 run scoreboard players set @s swrg.lives 0
#say start