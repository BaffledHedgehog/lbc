scoreboard players operation tmparmor lbc.math = tmp3t lbc.math
...
item replace block 10241024 71 10241024 container.5 from entity @s armor.legs
function lbc:swrg_kit_integration/game/skills/armored_damaged_toughness_storage with storage lbc.math


item replace entity @s armor.legs from block 10241024 71 10241024 container.5

scoreboard players set dmg3t lbc.math 1