...
execute if score tmp10 lbc.math matches ..2 if score tmp20 lbc.math matches ..2 if score tmp30 lbc.math matches ..2 if score tmp40 lbc.math matches ..2 run scoreboard players set if0 lbc.math 0
