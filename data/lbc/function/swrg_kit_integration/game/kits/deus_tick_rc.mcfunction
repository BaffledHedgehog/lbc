...
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..12,tag=!caster,tag=!spectator,limit=1] run function lbc:swrg_kit_integration/game/kits/deus_tick_rc_at
