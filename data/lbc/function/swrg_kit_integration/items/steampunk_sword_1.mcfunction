...
$attribute @s minecraft:generic.movement_speed modifier add c1cda724-0ea2-460a-98b8-9631eafd2515 "spreeent" $(tmp1) add
$attribute @s minecraft:generic.attack_damage modifier add 585f98b8-a8b8-4e4c-838a-f2e124831040 "spreeent1" $(tmp2) add
