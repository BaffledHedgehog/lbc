...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:1}]
execute unless score @s touhou_power matches 150 run scoreboard players operation @s touhou_power += tmp lbc.math
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:2}]
scoreboard players operation tmp lbc.math *= 10 lbc.math
execute unless score @s touhou_power matches 150 run scoreboard players operation @s touhou_power += tmp lbc.math
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:3}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:4}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:5}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:6}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:7}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:8}]
...
execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:9}]
scoreboard players operation @s manaregen += tmp lbc.math


execute store result score tmp lbc.math run clear @s *[custom_data~{touhou_item:10}]
