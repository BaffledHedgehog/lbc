summon pig ~ ~ ~ {Tags:["hook_sit","lucky_mob"],DeathLootTable:"empty",Invulnerable:1b,Silent:1b,active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:false}]}
