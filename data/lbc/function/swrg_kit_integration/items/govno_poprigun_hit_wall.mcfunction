...
fill ~1.5 ~1.5 ~1.5 ~-1.5 ~-1.5 ~-1.5 minecraft:podzol replace minecraft:rooted_dirt strict
fill ~1.5 ~1.5 ~1.5 ~-1.5 ~-1.5 ~-1.5 minecraft:rooted_dirt replace #minecraft:tannerkivi_no_dirt strict
