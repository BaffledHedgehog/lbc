...
execute if score ranked lbc.event matches 1 run return run function lbc:swrg_kit_integration/gui/page/10100_ranked
# НЕ ЗАБЫВАТЬ МЕНЯТЬ                                                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
item modify entity @s[scores={lbc.skill=30}] enderchest.2 swrg:select
item modify entity @s[scores={lbc.skill=31}] enderchest.3 swrg:select
item modify entity @s[scores={lbc.skill=32}] enderchest.4 swrg:select
item modify entity @s[scores={lbc.skill=33}] enderchest.5 swrg:select
item modify entity @s[scores={lbc.skill=34}] enderchest.6 swrg:select
item modify entity @s[scores={lbc.skill=35}] enderchest.7 swrg:select
item modify entity @s[scores={lbc.skill=36}] enderchest.8 swrg:select
item modify entity @s[scores={lbc.skill=37}] enderchest.9 swrg:select
item modify entity @s[scores={lbc.skill=38}] enderchest.10 swrg:select
item modify entity @s[scores={lbc.skill=39}] enderchest.11 swrg:select
item modify entity @s[scores={lbc.skill=40}] enderchest.12 swrg:select
item modify entity @s[scores={lbc.skill=41}] enderchest.13 swrg:select
item modify entity @s[scores={lbc.skill=42}] enderchest.14 swrg:select
item modify entity @s[scores={lbc.skill=43}] enderchest.15 swrg:select
item modify entity @s[scores={lbc.skill=44}] enderchest.16 swrg:select
item modify entity @s[scores={lbc.skill=45}] enderchest.17 swrg:select

item modify entity @s[scores={lbc.skill=47}] enderchest.19 swrg:select
item modify entity @s[scores={lbc.skill=48}] enderchest.20 swrg:select
item modify entity @s[scores={lbc.skill=49}] enderchest.21 swrg:select
item modify entity @s[scores={lbc.skill=50}] enderchest.22 swrg:select
item modify entity @s[scores={lbc.skill=51}] enderchest.23 swrg:select
