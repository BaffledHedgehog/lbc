...
item replace entity @s[advancements={lbc:true_advancements/bows/railshish=false}] enderchest.0 with minecraft:repeating_command_block[minecraft:item_model={floats:[669.0f]}]
item replace entity @s[advancements={lbc:true_advancements/bows/randchanted=false}] enderchest.1 with minecraft:repeating_command_block[minecraft:item_model={floats:[669.0f]}]
item replace entity @s[advancements={lbc:true_advancements/bows/shulker=false}] enderchest.2 with minecraft:repeating_command_block[minecraft:item_model={floats:[669.0f]}]
item replace entity @s[advancements={lbc:true_advancements/legends/academy/blood=false}] enderchest.3 with minecraft:repeating_command_block[minecraft:item_model={floats:[669.0f]}]
