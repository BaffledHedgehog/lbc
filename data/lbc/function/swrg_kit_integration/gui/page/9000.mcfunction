...
execute if score ranked lbc.event matches 1 run return run function lbc:swrg_kit_integration/gui/page/9000_ranked
# НЕ ЗАБЫВАТЬ МЕНЯТЬ                                                           ^^^^^^^^^^^^^^^^^^^^
...
item replace entity @s[advancements={lbc:true_advancements/accesories/sand_amulet=false}] enderchest.2 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/arcanums/barrier_and_heal=false}] enderchest.3 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/arcanums/kiuaskivi=false}] enderchest.4 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/chaos_full=false}] enderchest.5 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/moisei_boots=false}] enderchest.6 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/multiplying=false}] enderchest.7 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/nano=false}] enderchest.8 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/phantom=false}] enderchest.9 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/shitty=false}] enderchest.10 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/steampunk=false}] enderchest.11 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/armor/technomk2=false}] enderchest.12 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/axes/randchanted=false}] enderchest.13 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/bows/firework=false}] enderchest.14 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/hoes/op_hoe=false}] enderchest.15 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/legends/academy/acid_tuntija=false}] enderchest.16 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
item replace entity @s[advancements={lbc:true_advancements/legends/academy/badwiki=false}] enderchest.17 with minecraft:repeating_command_block[minecraft:item_model="lbc:locked"]
