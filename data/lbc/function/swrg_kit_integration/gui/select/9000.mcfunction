execute if score ranked lbc.event matches 1 run return run function lbc:swrg_kit_integration/gui/select/9000_ranked
# НЕ ЗАБЫВАТЬ МЕНЯТЬ                                                                   ^^^^^^^^^^^^^^^^^^^^
...
tellraw @s[scores={swrg.gui_select=0},advancements={lbc:true_advancements/accesories/devilstomach=false}] {"translate":"lbc.adv.accessories.devil_stomach.lore"}
tellraw @s[scores={swrg.gui_select=1},advancements={lbc:true_advancements/accesories/popit=false}] {"translate":"lbc.adv.accessories.popit.lore"}
tellraw @s[scores={swrg.gui_select=2},advancements={lbc:true_advancements/accesories/sand_amulet=false}] {"translate":"lbc.adv.accessories.sand_amulet.lore"}
tellraw @s[scores={swrg.gui_select=3},advancements={lbc:true_advancements/arcanums/barrier_and_heal=false}] {"translate":"lbc.adv.arcanums.barrier_and_heal.lore"}
tellraw @s[scores={swrg.gui_select=4},advancements={lbc:true_advancements/arcanums/kiuaskivi=false}] {"translate":"lbc.adv.arcanums.kiuaskivi.lore"}
tellraw @s[scores={swrg.gui_select=5},advancements={lbc:true_advancements/armor/chaos_full=false}] {"translate":"lbc.adv.armor.chaos_full.lore"}
tellraw @s[scores={swrg.gui_select=6},advancements={lbc:true_advancements/armor/moisei_boots=false}] {"translate":"lbc.adv.armor.moisei.lore"}
tellraw @s[scores={swrg.gui_select=7},advancements={lbc:true_advancements/armor/multiplying=false}] {"translate":"lbc.adv.armor.multiplying.lore"}
tellraw @s[scores={swrg.gui_select=8},advancements={lbc:true_advancements/armor/nano=false}] {"translate":"lbc.adv.armor.nano.lore"}
tellraw @s[scores={swrg.gui_select=9},advancements={lbc:true_advancements/armor/phantom=false}] {"translate":"lbc.adv.armor.phantom.lore"}
tellraw @s[scores={swrg.gui_select=10},advancements={lbc:true_advancements/armor/shitty=false}] {"translate":"lbc.adv.armor.shitty.lore"}
tellraw @s[scores={swrg.gui_select=11},advancements={lbc:true_advancements/armor/steampunk=false}] {"translate":"lbc.adv.armor.steampunk.lore"}
tellraw @s[scores={swrg.gui_select=12},advancements={lbc:true_advancements/armor/technomk2=false}] {"translate":"lbc.adv.armor.technomk2.lore"}
tellraw @s[scores={swrg.gui_select=13},advancements={lbc:true_advancements/axes/randchanted=false}] {"translate":"lbc.adv.axe.randchanted.lore"}
tellraw @s[scores={swrg.gui_select=14},advancements={lbc:true_advancements/bows/firework=false}] {"translate":"lbc.adv.bow.firework.lore"}
tellraw @s[scores={swrg.gui_select=15},advancements={lbc:true_advancements/hoes/op_hoe=false}] {"translate":"lbc.adv.hoe.op_hoe.lore"}
