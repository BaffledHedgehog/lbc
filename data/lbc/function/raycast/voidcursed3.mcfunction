...
execute as @e[type=#minecraft:mobs,distance=..4,tag=!curseowner,tag=!curseowner1,tag=!spectator] run damage @s 0.3 generic
tp @e[type=!minecraft:player,distance=..8,tag=!void_curse,tag=!curseowner,tag=!curseowner1,tag=!strict_map_object] @s
