...
execute as @e[type=#minecraft:mobs,distance=..1.5,tag=!curseowner,tag=!curseowner1,tag=!spectator] run damage @s 0.2 generic
tp @e[type=!minecraft:player,distance=..3,tag=!void_curse,tag=!curseowner,tag=!curseowner1,tag=!strict_map_object] @s
