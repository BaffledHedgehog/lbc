...
execute if entity @s[tag=malevich] if predicate lbc:chance10 as @e[type=item,distance=..3,nbt=!{Item: {components: {"malevich": true}}}] at @s run function lbc:items_tick_act_m
