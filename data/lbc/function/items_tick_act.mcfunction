...
execute if entity @s[tag=glowing] run particle minecraft:end_rod ~ ~ ~ 0 0 0 0.2 1 force
...
execute if entity @s[tag=bad_apple_imba] run function lbc:other/imba/bad_apple/item_tick