...
execute store result score tmp lbc.math run random value -200..200
scoreboard players operation tmp2 lbc.math += tmp lbc.math
execute store result score tmp lbc.math run random value -1000..1000
scoreboard players operation tmp3 lbc.math += tmp lbc.math
execute store result entity @s Motion[0] double 0.0001 run scoreboard players get tmp1 lbc.math
execute store result entity @s Motion[1] double 0.0001 run scoreboard players get tmp2 lbc.math
execute store result entity @s Motion[2] double 0.0001 run scoreboard players get tmp3 lbc.math
