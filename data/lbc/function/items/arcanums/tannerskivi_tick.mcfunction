...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{tannerkivi:1}] if items entity @s weapon.offhand *[minecraft:custom_data~{tannerkivi:1}] run fill ~15 ~15 ~15 ~-15 ~-15 ~-15 minecraft:dirt replace #minecraft:tannerkivi
