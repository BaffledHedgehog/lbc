...
execute if entity @s[nbt={SelectedItem:{components:{"barrier_arcanum": true}},Inventory:[{Slot:-106b,components:{"barrier_arcanum": true}}]}] run fill ~1 ~2 ~1 ~-1 ~ ~-1 air
execute if entity @s[nbt={SelectedItem:{components:{"barrier_arcanum": true}},Inventory:[{Slot:-106b,components:{"barrier_arcanum": true}}]},predicate=lbc:sneak] run fill ~1 ~-1 ~1 ~-1 ~-1 ~-1 air
