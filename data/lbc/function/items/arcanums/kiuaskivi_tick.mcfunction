...
execute if entity @s[nbt={SelectedItem:{components:{"kiuaskivi": true}},Inventory:[{Slot:-106b,components:{"kiuaskivi": true}}]}] if predicate lbc:chance5 run function lbc:big_fire_fill
