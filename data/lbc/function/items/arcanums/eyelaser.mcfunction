...
execute as @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..7,tag=!raycaster,tag=!spectator,limit=1] positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0,dy=0,dz=0] run damage @s 0.05 minecraft:generic
