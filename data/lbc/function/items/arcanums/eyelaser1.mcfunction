...
execute if score @s Distance matches ..684 positioned ^ ^ ^.5 unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run function lbc:items/arcanums/eyelaser1