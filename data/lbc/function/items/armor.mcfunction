...
execute at @s[scores={nitro=1..},nbt={Inventory:[{Slot:100b,components:{"techno": true}}]},x_rotation=89..90] unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] run function lbc:workingitems/nitroboots
...
execute at @s[nbt={Inventory:[{Slot:100b,components:{"shulkshell": true}},{Slot:101b,components:{"shulkshell": true}},{Slot:102b,components:{"shulkshell": true}},{Slot:103b,components:{"shulkshell": true}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] positioned ^ ^ ^5 run spreadplayers ~ ~ 0 3 under 120 false @s[predicate=lbc:the_nether]
execute at @s[nbt={Inventory:[{Slot:100b,components:{"shulkshell": true}},{Slot:101b,components:{"shulkshell": true}},{Slot:102b,components:{"shulkshell": true}},{Slot:103b,components:{"shulkshell": true}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] positioned ^ ^ ^5 run spreadplayers ~ ~ 0 3 false @s[predicate=!lbc:the_nether]
execute at @s[nbt={Inventory:[{Slot:101b,components:{"chaoschestplate": true}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] unless entity @a[gamemode=!spectator,tag=nomagic_active,distance=..20] run function lbc:other/chaoschestplate/effectselect_jump
