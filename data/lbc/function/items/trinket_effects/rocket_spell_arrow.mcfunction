...
data modify entity @e[type=arrow,tag=rocket_spell,sort=nearest,limit=1,distance=..10] item.components."minecraft:potion_contents".custom_effects append value {id:"minecraft:raid_omen","show_icon":false,"show_particles":true,duration:10,"amplifier":125}
