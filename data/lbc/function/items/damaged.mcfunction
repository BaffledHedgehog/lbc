...
execute at @s[scores={hplvl=..20},predicate=lbc:chance70] if items entity @s armor.head *[minecraft:custom_data~{berserk:1}] if items entity @s armor.chest *[minecraft:custom_data~{berserk:1}] if items entity @s armor.legs *[minecraft:custom_data~{berserk:1}] if items entity @s armor.feet *[minecraft:custom_data~{berserk:1}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:armor/set_bonus/berserk4
execute at @s[predicate=lbc:chance20] if items entity @s armor.chest *[minecraft:custom_data~{shulkshell:1}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:armor/shulker_teleport
execute at @s if items entity @s armor.head *[minecraft:custom_data~{technomk2:1}] if items entity @s armor.chest *[minecraft:custom_data~{technomk2:1}] if items entity @s armor.legs *[minecraft:custom_data~{technomk2:1}] if items entity @s armor.feet *[minecraft:custom_data~{technomk2:1}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper,limit=1] if score @s technomk2shield matches 0 run function lbc:armor/set_bonus/technomk2/damaged
execute if items entity @s armor.* *[minecraft:custom_data~{glass:1}] run function lbc:armor/glass/damaged
execute if score @s nanobots_tier matches 1.. run function lbc:armor/nanobots/damaged
execute at @s[tag=techno_set_bonus_active] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper,limit=1] anchored eyes positioned ^ ^ ^ run function lbcr:raycast_preloop10_setbonus
