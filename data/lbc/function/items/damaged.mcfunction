...
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":1}}}]}] resistance 1 3 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":2}}}]}] instant_damage 1 0 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":3}}}]}] speed 10 1 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":4}}}]}] slowness 10 2 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":5}}}]}] strength 10 1 true
effect give @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"mystical_old":4,"type":6}}}]}] weakness 10 0 true
