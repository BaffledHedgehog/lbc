...
# chaos chestplate
execute at @s[nbt={Inventory:[{Slot:102b,components:{"chaoschestplate": true}}]}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] unless entity @a[gamemode=!spectator,tag=nomagic_active,distance=..20,limit=1] run function lbc:other/chaoschestplate/effectselect
# chaos chestplate
...
execute at @s[nbt={Inventory:[{Slot:102b,components:{"shulkshell": true}}]},predicate=lbc:chance20] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:armor/shulker_teleport

execute at @s[nbt={Inventory: [{Slot: 103b, components: {"technomk2": true}},{Slot: 102b, components: {"technomk2": true}},{Slot: 101b, components: {"technomk2": true}},{Slot: 100b, components: {"technomk2": true}}]}] if score @s technomk2shield matches 0 run function lbc:armor/set_bonus/technomk2/damaged
execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"glass":true}}}]}] run function lbc:armor/glass/damaged
execute if entity @s[nbt={Inventory:[{components:{"nanobots": true}}]}] run function lbc:armor/nanobots/damaged
execute at @s[nbt={Inventory:[{Slot:102b,components:{"techno": true}},{Slot:101b,components:{"techno": true}},{Slot:100b,components:{"techno": true}},{Slot:103b,components:{"techno": true}}]}] unless entity @s[nbt={Inventory:[{Slot:102b,components:{"technomk2": true}},{Slot:101b,components:{"technomk2": true}},{Slot:100b,components:{"technomk2": true}},{Slot:103b,components:{"technomk2": true}}]}] unless entity @e[type=marker,tag=stopper,distance=..20,limit=1] anchored eyes positioned ^ ^ ^ run function lbcr:raycast_preloop10_setbonus
