execute store result score tmp lbc.math run clear @s *[minecraft:custom_data~{trinket:"drojji"}] 0
...
execute store result score tmp lbc.math run clear @s *[minecraft:custom_data~{trinket:"mandoahuet"}] 0
