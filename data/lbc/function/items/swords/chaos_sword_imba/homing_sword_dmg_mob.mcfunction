...
execute unless entity @e[tag=dungeon_mob,limit=1,distance=..20] as @e[type=#mobs,limit=1,tag=!dungeon_mob,tag=!spectator,distance=..8,dx=0,dy=0,dz=0] run damage @s 4 generic
