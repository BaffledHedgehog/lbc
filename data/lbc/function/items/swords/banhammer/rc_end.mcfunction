...
execute align y positioned ~ ~200 ~ run summon item_display ~ ~ ~ {Tags:["banhammer3d","slowraycast","player"],view_range:10f,item:{id:"minecraft:carrot_on_a_stick",Count:1b,components:{"minecraft:custom_model_data":723}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[4f,4f,4f]},teleport_duration:1}
