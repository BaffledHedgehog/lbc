...
execute if entity @e[type=#mobs,limit=1,tag=!dungeon_mob,tag=!spectator,distance=..8,dx=0,dy=0,dz=0] run function lbc:items/swords/chaos_sword_imba/homing_sword_dmg_mob
