...
execute store result entity @e[type=minecraft:arrow,distance=..0.01,tag=fast_crossbow_arrow,tag=!active,limit=1] Rotation[0] float -1 run data get entity @s Rotation[0] 1
execute store result entity @e[type=minecraft:arrow,distance=..0.01,tag=fast_crossbow_arrow,tag=!active,limit=1] Rotation[1] float -1 run data get entity @s Rotation[1] 1
