...
execute unless entity @a[tag=nodmg,limit=1] as @e[type=#mobs,limit=1,tag=!nodmg,tag=!spectator,distance=..8,dx=0,dy=0,dz=0] run damage @s 2.5 arrow
...
execute if entity @s[tag=strong] unless entity @a[tag=nodmg,limit=1] as @e[type=#mobs,limit=1,tag=!nodmg,tag=!spectator,distance=..8,dx=0,dy=0,dz=0] run damage @s 5 arrow
...
execute if entity @s[tag=overheavened] unless entity @a[tag=nodmg,limit=1] as @e[type=#mobs,limit=1,tag=!nodmg,tag=!spectator,distance=..8,dx=0,dy=0,dz=0] run damage @s 12.5 arrow
