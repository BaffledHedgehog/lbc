...
execute if items entity @s armor.chest *[minecraft:custom_data~{jumpboost:1}] if score @s falltimer matches 20.. unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:armor/traveller_chestplate
