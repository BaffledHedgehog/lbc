...
execute if score @s[nbt={Inventory:[{Slot:102b,components:{"jumpboost": true}}]}] falltimer matches 20.. unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:armor/traveller_chestplate
