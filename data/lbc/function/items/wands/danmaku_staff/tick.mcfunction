...
execute if score danmakuhand lbc.math matches 0 if entity @s[nbt={SelectedItem:{components:{danmaku_staff:1b}}}] run function lbc:items/wands/danmaku_staff/tick_right
execute if score danmakuhand lbc.math matches 1 if entity @s[nbt={Inventory:[{Slot:-106b,components:{danmaku_staff:1b}}]}] run function lbc:items/wands/danmaku_staff/tick_left
...
execute if score danmakuhand lbc.math matches 0 unless entity @s[nbt={SelectedItem:{components:{uniwand:100b}}}] unless entity @s[nbt={SelectedItem:{components:{spellid:159}}}] unless entity @s[nbt={Inventory:[{components:{danmaku_staff:1b}}]}] run function lbc:items/wands/danmaku_staff/tick_right
