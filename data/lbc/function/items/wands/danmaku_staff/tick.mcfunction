...
execute if score danmakuhand lbc.math matches 0 if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{danmaku_staff:1}}}}] if entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{danmaku_staff:1,upgraded:1}}}}] run function lbc:items/wands/danmaku_staff/tick_right
execute if score danmakuhand lbc.math matches 1 if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{danmaku_staff:1}},Slot:-106b}]}] if entity @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{danmaku_staff:1,upgraded:1}},Slot:-106b}]}] run function lbc:items/wands/danmaku_staff/tick_left

execute if score danmakuhand lbc.math matches 0 if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{danmaku_staff:1,upgraded:1}}}}] run function lbc:items/wands/danmaku_staff/tick_right_upgraded
execute if score danmakuhand lbc.math matches 1 if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{danmaku_staff:1,upgraded:1}},Slot:-106b}]}] run function lbc:items/wands/danmaku_staff/tick_left_upgraded
