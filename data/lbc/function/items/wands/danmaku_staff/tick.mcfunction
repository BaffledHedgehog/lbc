...
execute if score danmakuhand lbc.math matches 0 if entity @s[nbt={SelectedItem:{components:{"uniwand": true}}}] run function lbc:items/wands/danmaku_staff/tick_right
execute if score danmakuhand lbc.math matches 1 if entity @s[nbt={Inventory:[{Slot:-106b,components:{"uniwand": true}}]}] run function lbc:items/wands/danmaku_staff/tick_left
