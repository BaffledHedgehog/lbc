...
execute if entity @s[tag=acidballer] if score @s Lifetime matches ..39 facing ~ 0 ~ if predicate lbc:chance15 run return run function lbc:items/wands/sauvojen_wand/meditate/loop_particle_12
