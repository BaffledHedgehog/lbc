tag @s[nbt={Inventory:[{components:{"gaara": true}}]}] add gaara_active
tag @s[nbt={Inventory:[{Slot:101b,components:{"jumpboost": true}}]}] add jump_boost_active
...
tag @s[nbt=!{Inventory:[{components:{"gaara": true}}]}] remove gaara_active
tag @s[nbt=!{Inventory:[{Slot:101b,components:{"jumpboost": true}}]}] remove jump_boost_active
...
tag @s[nbt=!{Inventory:[{components:{"instantitem":true}}]}] remove instantitem_active
...
execute if entity @s[tag=phantomset,nbt=!{Inventory: [{Slot: 100b, components: {"phantom": true}}, {Slot: 101b, components: {"phantom": true}}, {Slot: 102b, components: {"phantom": true}}, {Slot: 103b, components: {"phantom": true}}]}] run function lbc:armor/phantom_set_bonus_clear
tag @s[nbt={Inventory: [{components: {yellow_lightning: 1b}}]}] add yellow_lightning_active
tag @s[nbt={Inventory: [{components: {erosion: 1b}}]}] add erosion_active
...
tag @s[nbt=!{Inventory: [{components: {erosion: 1b}}]}] remove erosion_active
...
execute unless data entity @s Inventory.[{Slot:102b}].tag.AttributeModifiers run function lbc:items/changed_inventory/fix_attribute_chest
execute unless data entity @s Inventory.[{Slot:103b}].tag.AttributeModifiers run function lbc:items/changed_inventory/fix_attribute_head

execute if entity @s[nbt={Inventory:[{Slot:100b,components:{"flesh": true}},{Slot:101b,components:{"flesh": true}},{Slot:102b,components:{"flesh": true}},{Slot:103b,components:{"flesh": true}}]}] run function lbc:armor/flesh_set_bonus_add
execute unless entity @s[nbt={Inventory:[{Slot:100b,components:{"flesh": true}},{Slot:101b,components:{"flesh": true}},{Slot:102b,components:{"flesh": true}},{Slot:103b,components:{"flesh": true}}]}] run function lbc:armor/flesh_set_bonus_remove
