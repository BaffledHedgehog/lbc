...
tag @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"gownoleggings": true}}}]}] add gowno_active
tag @s[nbt={Inventory:[{Slot:103b,components: {"minecraft:custom_data":{"techno": true}}}]}] add techno_active
tag @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"death_compass": true}}}]}] add death_compass_active
tag @s[nbt={Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:101b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:102b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:103b,components:{"minecraft:custom_data":{"paladin": true}}}]}] add paladin_full_active
tag @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"nanobots": true}}}]}] add nanobots_active
...
tag @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{"gownoleggings": true}}}]}] remove gowno_active
tag @s[nbt=!{Inventory:[{Slot:103b,components: {"minecraft:custom_data":{"techno": true}}}]}] remove techno_active
tag @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{"death_compass": true}}}]}] remove death_compass_active
tag @s[nbt=!{Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:101b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:102b,components:{"minecraft:custom_data":{"paladin": true}}},{Slot:103b,components:{"minecraft:custom_data":{"paladin": true}}}]}] remove paladin_full_active
tag @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{"nanobots": true}}}]}] remove nanobots_active
...
tag @s[nbt={Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:101b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:102b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:103b,components:{"minecraft:custom_data":{"assasin": true}}}]}] add assasin_setbonus_active
...
tag @s[nbt=!{Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:101b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:102b,components:{"minecraft:custom_data":{"assasin": true}}},{Slot:103b,components:{"minecraft:custom_data":{"assasin": true}}}]}] remove assasin_setbonus_active
...
tag @s[nbt={Inventory: [{Slot: 100b, components:{"minecraft:custom_data":{"reactive": true}}}]},nbt=!{Inventory: [{Slot: 100b, components: {"minecraft:custom_data":{"technomk2": true}}}]}] add reactiveboots_active
...
tag @s[nbt=!{Inventory: [{Slot: 100b, components:{"minecraft:custom_data":{"reactive": true}}}]}] remove reactiveboots_active
...
tag @s[nbt={Inventory: [{Slot: 102b, components:{"minecraft:custom_data":{"chaoschestplate": true}}}]}] add chaosdust_active
execute if entity @s[nbt={Inventory: [{Slot: 100b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 101b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 102b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 103b, components:{"minecraft:custom_data":{"phantom": true}}}]}] run function lbc:armor/phantom_set_bonus_pre
execute if entity @s[tag=phantomset,nbt=!{Inventory: [{Slot: 100b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 101b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 102b, components:{"minecraft:custom_data":{"phantom": true}}}, {Slot: 103b, components:{"minecraft:custom_data":{"phantom": true}}}]}] run function lbc:armor/phantom_set_bonus_clear
tag @s[nbt={Inventory: [{components:{"minecraft:custom_data":{"yellow_lightning": true}}}]}] add yellow_lightning_active
...
tag @s[nbt=!{Inventory: [{Slot: 102b, components:{"minecraft:custom_data":{"chaoschestplate": true}}}]}] remove chaosdust_active
tag @s[nbt=!{Inventory: [{components:{"minecraft:custom_data":{"yellow_lightning": true}}}]}] remove yellow_lightning_active
tag @s[nbt=!{Inventory: [{components:{"minecraft:custom_data":{"erosion": true}}}]}] remove erosion_active
...
tag @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"stand_clocks": true}}}]}] add have_stand_clocks_active
...
tag @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{"stand_clocks": true}}}]}] remove have_stand_clocks_active

tag @s[nbt={Inventory:[{components:{"minecraft:custom_data":{"stand_clocks": true}}}]}] add stand_clocks_active
tag @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{"stand_clocks": true}}}]}] remove stand_clocks_active

tag @s[nbt={Inventory:[{Slot:103b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:102b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:101b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:100b,components:{"minecraft:custom_data":{"overload": true}}}]}] add overload_full_active
tag @s[nbt=!{Inventory:[{Slot:103b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:102b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:101b,components:{"minecraft:custom_data":{"overload": true}}},{Slot:100b,components:{"minecraft:custom_data":{"overload": true}}}]}] remove overload_full_active

tag @s[nbt={Inventory:[{Slot:103b,components:{"minecraft:custom_data":{"overload": true}}}]}] add overload_helmet_active
tag @s[nbt=!{Inventory:[{Slot:103b,components:{"minecraft:custom_data":{"overload": true}}}]}] remove overload_helmet_active

tag @s[nbt={Inventory:[{Slot:102b,components:{"minecraft:custom_data":{"overload": true}}}]}] add overload_chestplate_active
tag @s[nbt=!{Inventory:[{Slot:102b,components:{"minecraft:custom_data":{"overload": true}}}]}] remove overload_chestplate_active

tag @s[nbt={Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"overload": true}}}]}] add overload_leggings_active
tag @s[nbt=!{Inventory:[{Slot:101b,components:{"minecraft:custom_data":{"overload": true}}}]}] remove overload_leggings_active

tag @s[nbt={Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"overload": true}}}]}] add overload_boots_active
tag @s[nbt=!{Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"overload": true}}}]}] remove overload_boots_active
...
execute if entity @s[nbt={Inventory:[{Slot:100b,components:{"minecraft:custom_data":{"flesh": true}}},{Slot:101b,components:{"minecraft:custom_data":{"flesh": true}}},{Slot:102b,components:{"minecraft:custom_data":{"flesh": true}}},{Slot:103b,components:{"minecraft:custom_data":{"flesh": true}}}]}] run function lbc:armor/flesh_set_bonus_add
