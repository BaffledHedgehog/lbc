...
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{double:1}}}}] anchored eyes positioned ^ ^ ^ run function lbc:workingitems/doublebow
...
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{shulker_new:1}}}}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:workingitems/shulkerbow_new
...
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{madoka_bow:1}}}}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:items/bows/kaname_bow/shoot
execute if score #lbctrinket swrg.math matches 1.. run function lbc:items/bows_get_trinket
execute if score #lbcskill swrg.math matches 1.. run function lbc:swrg_kit_integration/game/skills/bow_shoot

execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{tmt_item:1}}}}] unless score @s tmticked matches 1 run function lbc:drops/tmt/trigger_smth_not_bow
