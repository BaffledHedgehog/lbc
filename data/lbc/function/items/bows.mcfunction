...
# Double bow
execute at @s[nbt={SelectedItem:{components:{"double": true}}}] anchored eyes positioned ^ ^ ^ run function lbc:workingitems/doublebow
...
# shulker bow
execute at @s[nbt={SelectedItem:{components:{"shulker": true}}}] unless entity @e[type=marker,tag=stopper_magic,distance=..20,limit=1] run function lbc:workingitems/shulkerbow
# shulker bow
