...
data modify entity @e[type=#arrows,limit=1,sort=nearest,distance=..10,nbt={item:{components:{"minecraft:potion_contents":{custom_color:6710877}}}}] Rotation set from entity @s Rotation
