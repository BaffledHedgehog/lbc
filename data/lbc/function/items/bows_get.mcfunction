...
execute if score #lbclevelup swrg.math matches 1 if entity @s[tag=strong_charge_1] as @e[type=#minecraft:arrows,distance=..10,sort=nearest,limit=1] at @s run function lbc:items/damage_up_1
execute if score #lbclevelup swrg.math matches 1 if entity @s[tag=gravitas] as @e[type=#minecraft:arrows,distance=..10,sort=nearest,limit=1] at @s run data modify entity @s NoGravity set value 1b
