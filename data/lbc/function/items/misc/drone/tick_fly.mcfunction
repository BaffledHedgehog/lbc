...
execute facing entity @e[type=#minecraft:mobs,tag=dron_target,tag=!spectator,limit=1,tag=!strict_map_object] eyes positioned ^ ^ ^0.1 rotated as @s positioned ^ ^ ^1 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^1 ~ ~
