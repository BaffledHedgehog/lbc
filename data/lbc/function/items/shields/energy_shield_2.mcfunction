execute as @e[type=#minecraft:raycasters_projectiles,distance=..7] at @s run function lbc:items/shields/energy_shield_proj
...
scoreboard players operation @e[type=#minecraft:raycasters_projectiles,distance=..7,tag=mirrored] team_number = @s team_number

tag @e[type=#minecraft:raycasters_projectiles,distance=7..14,tag=mirrored] remove mirrored
