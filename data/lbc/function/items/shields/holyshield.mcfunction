...
execute unless score time_stopped lbc.math matches 1.. anchored eyes positioned ^ ^ ^3 at @e[type=#unholy_monsters,distance=..4] run particle dust{color:[1.0,1.0,0.0],scale:1} ~ ~1 ~ 0.3 0.7 0.3 0 10 normal
