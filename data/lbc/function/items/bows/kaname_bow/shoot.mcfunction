...
data modify entity @e[type=arrow,tag=madoka_arrow,sort=nearest,limit=1,distance=..25] item.components."minecraft:potion_contents".custom_effects append value {id:"raid_omen","show_icon":false,"show_particles":false,duration:2,"amplifier":76}
