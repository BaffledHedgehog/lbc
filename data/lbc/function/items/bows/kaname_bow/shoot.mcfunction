...
data modify entity @e[type=arrow,tag=madoka_arrow,sort=nearest,limit=1,distance=..25] item.components."minecraft:potion_contents".custom_effects append value {id:"minecraft:raid_omen","show_icon":false,"show_particles":true,duration:10,"amplifier":76}
