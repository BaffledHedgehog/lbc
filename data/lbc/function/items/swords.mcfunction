...
execute at @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{mortis:1}}}}] facing entity @e[distance=..7,tag=!spectator,limit=1,nbt={HurtTime:10s},tag=!strict_map_object] eyes rotated ~ 0 run function lbc:mortisbreak
...
scoreboard players add @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{fartus_nadristailo:1,upgraded:1}}}}] fartus_sword 1
