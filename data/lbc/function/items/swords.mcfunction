...
execute at @s[gamemode=!spectator,nbt={Inventory:[{components:{"minecraft:custom_data":{phantom:1}},Slot:100b},{components:{"minecraft:custom_data":{phantom:1}},Slot:101b},{components:{"minecraft:custom_data":{phantom:1}},Slot:102b},{components:{"minecraft:custom_data":{phantom:1}},Slot:103b}]}] unless entity @a[gamemode=!spectator,distance=..20,tag=nomagic_active,limit=1] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:workingitems/phantom
...
execute at @s[nbt={Inventory:[{components:{"minecraft:custom_data":{nyauwu:1}},Slot:102b}]}] unless entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run function lbc:other/manaregen_hit
