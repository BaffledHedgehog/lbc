...
execute if score @s effect_small_explosion matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE137 ","extra":[{"score":{"name":"@s","objective":"effect_small_explosion"},"color":"white"}]}'
execute if score @s effect_lightning_bolt matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE138 ","extra":[{"score":{"name":"@s","objective":"effect_lightning_bolt"},"color":"white"}]}'
execute if score @s effect_firebreak matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE139 ","extra":[{"score":{"name":"@s","objective":"effect_firebreak"},"color":"white"}]}'
execute if score @s effect_explosion matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE140 ","extra":[{"score":{"name":"@s","objective":"effect_explosion"},"color":"white"}]}'
execute if score @s effect_big_explosion matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE141 ","extra":[{"score":{"name":"@s","objective":"effect_big_explosion"},"color":"white"}]}'
...
execute if score @s effect_traps matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE143 ","extra":[{"score":{"name":"@s","objective":"effect_traps"},"color":"white"}]}'
execute if score @s effect_evoker matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE144 ","extra":[{"score":{"name":"@s","objective":"effect_evoker"},"color":"white"}]}'
execute if score @s effect_shock matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE145 ","extra":[{"score":{"name":"@s","objective":"effect_shock"},"color":"white"}]}'
execute if score @s effect_kiuaskivi matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE146 ","extra":[{"score":{"name":"@s","objective":"effect_kiuaskivi"},"color":"white"}]}'
execute if score @s effect_lightarrow matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE147 ","extra":[{"score":{"name":"@s","objective":"effect_lightarrow"},"color":"white"}]}'
execute if score @s effect_evokerarrow matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE148 ","extra":[{"score":{"name":"@s","objective":"effect_evokerarrow"},"color":"white"}]}'
...
execute if score @s effect_witch_gens_reset matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE150 ","extra":[{"score":{"name":"@s","objective":"effect_witch_gens_reset"},"color":"white"}]}'
execute if score @s effect_hedgehog_boom matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE151 ","extra":[{"score":{"name":"@s","objective":"effect_hedgehog_boom"},"color":"white"}]}'
execute if score @s effect_stand_arrow_hit matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE152 ","extra":[{"score":{"name":"@s","objective":"effect_stand_arrow_hit"},"color":"white"}]}'
execute if score @s effect_nuking matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE153 ","extra":[{"score":{"name":"@s","objective":"effect_nuking"},"color":"white"}]}'
execute if score @s effect_vacuum matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE154 ","extra":[{"score":{"name":"@s","objective":"effect_vacuum"},"color":"white"}]}'
execute if score @s effect_timestop matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE155 ","extra":[{"score":{"name":"@s","objective":"effect_timestop"},"color":"white"}]}'
execute if score @s effect_chain_lightning matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE156 ","extra":[{"score":{"name":"@s","objective":"effect_chain_lightning"},"color":"white"}]}'
execute if score @s effect_add_mana matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE157 ","extra":[{"score":{"name":"@s","objective":"effect_add_mana"},"color":"white"}]}'
execute if score @s effect_add_manamax matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE158 ","extra":[{"score":{"name":"@s","objective":"effect_add_manamax"},"color":"white"}]}'
execute if score @s effect_add_manaregen matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE159 ","extra":[{"score":{"name":"@s","objective":"effect_add_manaregen"},"color":"white"}]}'
execute if score @s effect_remove_mana matches 1.. run data modify storage lbc.math ui append value '{"text":" \\uE160 ","extra":[{"score":{"name":"@s","objective":"effect_remove_mana"},"color":"white"}]}'
