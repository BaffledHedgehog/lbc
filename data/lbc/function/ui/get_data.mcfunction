...
execute if entity @e[type=minecraft:marker,distance=..20,tag=stopper_magic,limit=1] run data modify storage lbc.math ui append value {"text":" \uE175","color":"#4E5C24"}
execute if entity @e[type=minecraft:marker,distance=..20,tag=stopper,limit=1] run data modify storage lbc.math ui append value {"text":" \uE176","color":"#4E5C24"}
...
execute if score @s effect_shock_potion matches 1.. run data modify storage lbc.math ui append value {"text":"  \uE156 ","extra":[{"score":{"name":"@s","objective":"effect_shock_potion"},"color":"white"}]}
...
execute if score @s stone_layers matches 1.. run data modify storage lbc.math ui append value {"text":"  \uE205 ","extra":[{"score":{"name":"@s","objective":"stone_layers"},"color":"white"}]}
execute if score @s stone_cd matches 1.. run data modify storage lbc.math ui append value {"text":" | ","extra":[{"score":{"name":"@s","objective":"stone_cd"},"color":"gray"}]}
...
execute unless score legacy lbc.math matches 1 if entity @s[scores={skill_issue=1..}] run title @s title {"storage":"lbc.math","nbt":"ui2","separator":"","interpret":true,"source":"storage","type":"nbt"}
execute unless score legacy lbc.math matches 1 if items entity @s armor.head *[minecraft:custom_data~{bucket_head:1}] run title @s title {"storage":"lbc.math","nbt":"ui2","separator":"","interpret":true,"source":"storage","type":"nbt"}
