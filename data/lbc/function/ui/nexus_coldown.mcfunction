...
execute if entity @s[nbt={SelectedItem:{components:{"nexus_compass": true}}},scores={nexus_compass_cd=1..}] run data modify storage lbc.math ui append value '{"text":"    \\uE105 ","extra":[{"score":{"name":"@s","objective":"nexus_compass_cd"},"color":"white"}]}'
execute if entity @s[nbt={SelectedItem:{components:{"nexus_compass": true}}},scores={nexus_compass_cd=..0}] run data modify storage lbc.math ui append value '{"text":"    \\uE104 ","extra":[{"translate":"ready","color":"green"}]}'
