...
execute if entity @s[tag=have_stand] unless items entity @s container.* *[minecraft:custom_data~{oraora:1}] unless items entity @s weapon.* *[minecraft:custom_data~{oraora:1}] run loot give @s loot lbc:stand_oraora
