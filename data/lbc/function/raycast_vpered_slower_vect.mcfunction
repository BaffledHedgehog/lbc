...
execute positioned 0.0 0.0 0.0 positioned ^ ^ ^0.1 run summon marker ~ ~ ~ {Tags:["reycaster"]}
execute store result score mot0 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[0] 10000
execute store result score mot1 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[1] 50000
execute store result score mot2 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[2] 10000
...
execute unless block ~ ~1 ~ #airs run scoreboard players set @s y -10000
execute unless block ~ ~2 ~ #airs run scoreboard players set @s y -10000
execute unless block ~ ~3 ~ #airs run scoreboard players set @s y -10000
execute unless block ~ ~4 ~ #airs run scoreboard players set @s y -10000
execute unless block ~ ~5 ~ #airs run scoreboard players set @s y -10000
