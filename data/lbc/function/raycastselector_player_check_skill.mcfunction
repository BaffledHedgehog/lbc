...
execute at @a[gamemode=!spectator] if score @a[limit=1,distance=..0.01,gamemode=!spectator] team_number = @s team_number run tag @a[limit=1,distance=..0.01,gamemode=!spectator] add nodmg1
