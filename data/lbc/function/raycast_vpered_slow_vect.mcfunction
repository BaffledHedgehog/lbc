...
execute store result score mot0 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[0] 1000
execute store result score mot1 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[1] 1000
execute store result score mot2 lbc.math run data get entity @e[type=marker,tag=reycaster,limit=1] Pos[2] 1000
