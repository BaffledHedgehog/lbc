...
execute if predicate lbc:chance70 store result score #random_out lbc.math run random value -30..30
execute if predicate lbc:chance50 store result score #random_out lbc.math run random value -300..300
execute if predicate lbc:chance25 store result score #random_out lbc.math run random value -30000..30000
