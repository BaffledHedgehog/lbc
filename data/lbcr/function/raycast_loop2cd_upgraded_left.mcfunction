execute if predicate lbc:sneak if entity @s[x_rotation=0..90] run function lbc:other/magic_academy/change_mode_4_down_left
execute if predicate lbc:sneak if entity @s[x_rotation=-90..0] run function lbc:other/magic_academy/change_mode_4_left
