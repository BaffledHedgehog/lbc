...
execute at @s if entity @s[nbt={SelectedItem:{components:{"upgradable": true,"advancedteleport": true}}}] unless block ~ ~1 ~ #airs run function lbc:other/magic_academy/can_upgrade
