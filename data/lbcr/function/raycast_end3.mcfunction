...
execute at @s if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{"upgradable": true,"advancedteleport": true}}}}] unless block ~ ~1 ~ #airs run function lbc:other/magic_academy/can_upgrade
