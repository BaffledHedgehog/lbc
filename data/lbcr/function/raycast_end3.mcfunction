...
execute at @s if entity @s[nbt={SelectedItem:{components:{upgradable:1b,advancedteleport:1b}}}] unless block ~ ~1 ~ #airs run function lbc:other/magic_academy/can_upgrade
