...
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..15,tag=!spectator,tag=!god_hedgehog,limit=1] positioned ~-.99 ~-.99 ~-.99 if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..10,tag=!spectator,tag=!god_hedgehog,limit=1] positioned ~.99 ~.99 ~.99 run function lbcr:damagewithid3
