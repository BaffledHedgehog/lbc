...
execute positioned ~ ~1 ~ run scoreboard players operation @e[type=minecraft:marker,distance=..1,tag=blazespell,tag=!activatedblaze,limit=1] team_number = @s team_number
