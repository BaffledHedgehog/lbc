...
execute if entity @s[nbt={SelectedItem:{components:{upgradable:1b,wall:1b}}}] at @s anchored eyes rotated ~ 0 positioned ^ ^ ^1 run function lbcr:raycast_end2_check_wall_upgrade
