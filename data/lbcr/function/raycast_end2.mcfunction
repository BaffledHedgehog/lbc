...
execute if entity @s[nbt={SelectedItem:{components:{"upgradable": true,"wall": true}}}] at @s anchored eyes rotated ~ 0 positioned ^ ^ ^1 run function lbcr:raycast_end2_check_wall_upgrade
