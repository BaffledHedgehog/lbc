...
execute as @e[distance=..10,dx=0,dy=0,dz=0,type=#mobs,tag=!spectator,tag=!rcdenyalways,tag=!sauvojen_tuntija,tag=!transformator,tag=!cyborg_boss,tag=!summoned_cultist] run damage @s 0.5 arrow
