...
summon silverfish ~ ~ ~ {CustomName:'{"text":"HeavyHedgehog"}',Tags:["hedgehog_tank","hedgehog_upgraded"],attributes:[{id: "minecraft:generic.knockback_resistance",base:1000},{id: "minecraft:generic.attack_knockback",base:1},{id: "minecraft:generic.max_health",base:100},{id: "minecraft:generic.attack_damage",base:15}],Health:100f}
