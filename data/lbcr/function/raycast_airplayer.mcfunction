...
execute if entity @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..15,tag=!spectator,predicate=!lbc:same_id,predicate=!lbc:same_team,limit=1] run return run function lbcr:raycast_air_explode
