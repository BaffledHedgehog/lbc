...
execute if predicate lbc:sneak if score #mode lbc.math matches 2 run tellraw @s [{"translate":"mode_blaze_head"}]
execute unless predicate lbc:sneak run function lbcr:raycast_loop4cd_upgraded2