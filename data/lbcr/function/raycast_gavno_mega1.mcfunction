...
summon minecraft:falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,fall_distance:0.0f,FallHurtAmount:2.0f}
summon minecraft:falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,fall_distance:0.0f,FallHurtAmount:2.0f}
summon minecraft:falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,fall_distance:0.0f,FallHurtAmount:2.0f}
summon minecraft:falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,fall_distance:0.0f,FallHurtAmount:2.0f}
summon minecraft:falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,fall_distance:0.0f,FallHurtAmount:2.0f}
...
effect give @a[gamemode=!spectator,dx=0,dy=0,dz=0,distance=..15,tag=!nodmg,tag=!nodmg1] minecraft:nausea 15 0
effect give @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..15,tag=!spectator,tag=!nodmg,tag=!nodmg1] minecraft:wither 3 10
kill @s