...
summon falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,FallDistance:0f,FallHurtAmount:1f}
summon falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,FallDistance:0f,FallHurtAmount:1f}
summon falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,FallDistance:0f,FallHurtAmount:1f}
summon falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,FallDistance:0f,FallHurtAmount:1f}
summon falling_block ~ ~ ~ {Tags:["falling_shit"],BlockState:{Name:"minecraft:dirt"},Time:1,DropItem:1b,HurtEntities:1b,FallHurtMax:1000,FallDistance:0f,FallHurtAmount:1f}
