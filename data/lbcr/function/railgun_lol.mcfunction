...
execute if score tmp lbc.math matches 102 at @e[type=#minecraft:mobs,distance=0.01..8,tag=!spectator,tag=!owner,predicate=!lbc:same_team] unless entity @e[type=minecraft:evoker_fangs,distance=..1,limit=1] run function lbc:projectiles/arrows/evoker
