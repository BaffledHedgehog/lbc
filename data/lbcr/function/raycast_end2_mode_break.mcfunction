...
execute store result score tmp lbc.math run fill ~2 ~2 ~2 ~-2 ~-2 ~-2 minecraft:air replace #minecraft:bricks strict
execute if score tmp lbc.math matches 1.. run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:bricks",count:1},Tags:["brick"]}
execute if score tmp lbc.math matches 15.. run scoreboard players add @s mana 1500
