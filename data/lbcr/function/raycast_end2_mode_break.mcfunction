...
execute if score tmp lbc.math matches 1.. run scoreboard players add @s mana 3000
execute store result entity @e[type=item,limit=1,tag=brick,distance=..0.001] Item.Count byte 1 run scoreboard players get tmp lbc.math
