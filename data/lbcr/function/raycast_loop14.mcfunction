...
execute as @e[type=#minecraft:mobs,distance=0.01..6,tag=!nomagic_active,tag=!spectator,tag=!raycaster,predicate=!lbc:same_team] run damage @s 15 cactus by @p[gamemode=!spectator,tag=raycaster]
