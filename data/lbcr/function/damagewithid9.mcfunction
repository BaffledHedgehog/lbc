...
execute as @a[gamemode=!spectator,dx=0,dy=0,dz=0,distance=..15] if score @s team_number = @e[tag=hard_acid,sort=nearest,limit=1] team_number run tag @s add nodamage
