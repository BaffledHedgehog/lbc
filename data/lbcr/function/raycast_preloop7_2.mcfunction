...
execute if entity @s[nbt={SelectedItem:{components:{"upgradable": true,"prisma": true}}}] run tag @e[type=marker,tag=prism,limit=1,distance=..0.001,tag=!actived] add check
