...
execute as @e[type=#minecraft:mobs,dx=0,dy=0,dz=0,distance=..10,tag=!nodamage,tag=!nodamage1,tag=!spectator,limit=2] run damage @s 8 arrow by @e[type=#minecraft:player_marker,tag=nodamage,tag=!spectator,limit=1]
